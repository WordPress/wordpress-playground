...
### PHPServer<!-- -->(<!-- -->php<!-- -->: [PHP](./web.php.md)<!-- -->, config?<!-- -->: [PHPServerConfigation](./web.phpserverconfigation.md)<!-- -->)
...
-   `php` [PHP](./web.php.md) – The PHP instance
...
### request<!-- -->(<!-- -->request<!-- -->: [PHPServerRequest](./web.phpserverrequest.md)<!-- -->)<!-- -->: [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)<!-- -->&lt;[PHPResponse](./web.phpresponse.md)<!-- -->&gt;
