...
-   `fileInfos` [FileInfo](./php-wasm-node.fileinfo.md)<!-- -->[] – <b>(Optional)</b> Uploaded files.
-   `headers` [PHPRequestHeaders](./php-wasm-node.phprequestheaders.md) – <b>(Optional)</b> Request headers.
