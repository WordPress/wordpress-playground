...
<b>Implements:</b> [Promisify](./web.promisify.md)<!-- -->&lt;[WithRequest](./web.withrequest.md)<!-- -->&amp;[WithPHPIniBindings](./web.withphpinibindings.md)<!-- -->&amp;[WithFilesystem](./web.withfilesystem.md)<!-- -->&amp;[WithRun](./web.withrun.md)<!-- -->&amp;[WithProgress](./web.withprogress.md)<!-- -->&amp;[WithPathConversion](./web.withpathconversion.md)<!-- -->&gt;

A PHP client that can be used to run PHP code in the browser.

## Constructors

### PHPClient<!-- -->(<!-- -->browser<!-- -->: [PHPBrowser](./web.phpbrowser.md)<!-- -->, monitor?<!-- -->: [EmscriptenDownloadMonitor](./web.emscriptendownloadmonitor.md)<!-- -->)
...
### request<!-- -->(<!-- -->request<!-- -->: [PHPServerRequest](./web.phpserverrequest.md)<!-- -->, redirects?<!-- -->: [number](https://www.typescriptlang.org/docs/handbook/2/everyday-types.html#the-primitives-string-number-and-boolean)<!-- -->)<!-- -->: [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)<!-- -->&lt;[PHPResponse](./web.phpresponse.md)<!-- -->&gt;

-   `redirects` – Optional.

### run<!-- -->(<!-- -->request?<!-- -->: [PHPRequest](./web.phprequest.md)<!-- -->|[undefined](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/undefined)<!-- -->)<!-- -->: [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)<!-- -->&lt;[PHPResponse](./web.phpresponse.md)<!-- -->&gt;
