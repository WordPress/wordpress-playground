...
### PHPServer<!-- -->(<!-- -->php<!-- -->: [PHP](./php-wasm-web.php.md)<!-- -->, config?<!-- -->: [PHPServerConfigation](./php-wasm-web.phpserverconfigation.md)<!-- -->)
...
-   `php` [PHP](./php-wasm-web.php.md) – The PHP instance
...
### request<!-- -->(<!-- -->request<!-- -->: [PHPServerRequest](./php-wasm-web.phpserverrequest.md)<!-- -->)<!-- -->: [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)<!-- -->&lt;[PHPResponse](./php-wasm-web.phpresponse.md)<!-- -->&gt;
