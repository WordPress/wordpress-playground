...
## loadPHPRuntime() function
loadPHPRuntime<!-- -->(\
&emsp;&emsp;&emsp;<!-- -->phpLoaderModule<!-- -->: [PHPLoaderModule](./php-wasm-web.phploadermodule.md)<!-- -->, \
&emsp;&emsp;&emsp;<!-- -->phpModuleArgs?<!-- -->: [EmscriptenOptions](./php-wasm-web.emscriptenoptions.md)<!-- -->, \
&emsp;&emsp;&emsp;<!-- -->dataDependenciesModules?<!-- -->: [DataModule](./php-wasm-web.datamodule.md)<!-- -->[]\
