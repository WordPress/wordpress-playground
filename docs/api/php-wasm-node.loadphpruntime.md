...
loadPHPRuntime<!-- -->(\
&emsp;&emsp;&emsp;<!-- -->phpLoaderModule<!-- -->: [PHPLoaderModule](./php-wasm-node.phploadermodule.md)<!-- -->, \
&emsp;&emsp;&emsp;<!-- -->phpModuleArgs?<!-- -->: [EmscriptenOptions](./php-wasm-node.emscriptenoptions.md)<!-- -->, \
&emsp;&emsp;&emsp;<!-- -->dataDependenciesModules?<!-- -->: [DataModule](./php-wasm-node.datamodule.md)<!-- -->[]\
