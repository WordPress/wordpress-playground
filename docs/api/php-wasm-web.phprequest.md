...
* `fileInfos`    [FileInfo](./php-wasm-web.fileinfo.md)<!-- -->[] – <b>(Optional)</b> Uploaded files.
* `headers`    [PHPRequestHeaders](./php-wasm-web.phprequestheaders.md) – <b>(Optional)</b> Request headers.
