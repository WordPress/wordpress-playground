...
loadPHPRuntime<!-- -->(\
&emsp;&emsp;&emsp;<!-- -->phpLoaderModule<!-- -->: [PHPLoaderModule](./web.phploadermodule.md)<!-- -->, \
&emsp;&emsp;&emsp;<!-- -->phpModuleArgs?<!-- -->: [EmscriptenOptions](./web.emscriptenoptions.md)<!-- -->, \
&emsp;&emsp;&emsp;<!-- -->dataDependenciesModules?<!-- -->: [DataModule](./web.datamodule.md)<!-- -->[]\
