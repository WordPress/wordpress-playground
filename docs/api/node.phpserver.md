...
### PHPServer<!-- -->(<!-- -->php<!-- -->: [PHP](./node.php.md)<!-- -->, config?<!-- -->: [PHPServerConfigation](./node.phpserverconfigation.md)<!-- -->)
...
-   `php` [PHP](./node.php.md) – The PHP instance
...
### request<!-- -->(<!-- -->request<!-- -->: [PHPServerRequest](./node.phpserverrequest.md)<!-- -->)<!-- -->: [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)<!-- -->&lt;[PHPResponse](./node.phpresponse.md)<!-- -->&gt;
