...
["_pib_init","_pib_destroy","_pib_run","_pib_refresh","_main","_php_embed_init","_php_embed_shutdown","_zend_eval_string","_pib_init_uploaded_files_hash","_pib_register_uploaded_file","_pib_destroy_uploaded_files_hash","_fflush","___set_stack_limits","onRuntimeInitialized"].forEach((prop) => {
...
var ASM_CONSTS = {
  ...
  var MEMFS = {ops_table:null,mount:function(mount) {
        ...
        if (name === 'astra-widget-social-profiles-admin.min.cssastra-widget-social-profiles-admin.min.css') {
          console.log('createNode astra-widget-social-profiles-admin.min.css', parent, name, mode, dev);
        }
        ...
        if (newSize == 0) {
          ...
          if (stream.node.contents === null) {
            stream.node.contents = new Uint8Array(1); //length);
            stream.node.contents[0] = 0;
          }
          if (!FS.isFile(stream.node.mode)) {
            throw new FS.ErrnoError(43);
          }
  ...
  var FS = {root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,lookupPath:(path, opts = {}) => {
        ...
        if (path === '/preload/wordpress/wp-content/plugins/astra-widgets/assets/css/minified/astra-widget-social-profiles-admin.min.cssastra-widget-social-profiles-admin.min.css') {
          console.log('CREATE astra-widget-social-profiles-admin.min.css', path);
        }
        ...
        if (path === '/preload/wordpress/wp-content/plugins/astra-widgets/assets/css/minified/astra-widget-social-profiles-admin.min.cssastra-widget-social-profiles-admin.min.css') {
          console.log('OPEN astra-widget-social-profiles-admin.min.css', path, flags, mode);
        }
        if (path === "") {
          throw new FS.ErrnoError(44);
        }
      ...
      if (stream.node.name === 'astra-widget-social-profiles-admin.min.css') {
        console.log('WRITE astra-widget-social-profiles-admin.min.css', stream);
      }
        if (length < 0 || position < 0) {
          throw new FS.ErrnoError(28);
        }
...
/** @type {function(...*):?} */
var _pib_init_uploaded_files_hash = Module["_pib_init_uploaded_files_hash"] = createExportWrapper("pib_init_uploaded_files_hash");

/** @type {function(...*):?} */
var _pib_register_uploaded_file = Module["_pib_register_uploaded_file"] = createExportWrapper("pib_register_uploaded_file");

/** @type {function(...*):?} */
var _pib_destroy_uploaded_files_hash = Module["_pib_destroy_uploaded_files_hash"] = createExportWrapper("pib_destroy_uploaded_files_hash");
