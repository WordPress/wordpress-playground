<?php
 header( 'Content-Type: ' . feed_content_type( 'rss2' ) . '; charset=' . get_option( 'blog_charset' ), true ); echo '<?xml version="1.0" encoding="' . get_option( 'blog_charset' ) . '"?' . '>'; do_action( 'rss_tag_pre', 'rss2-comments' ); ?>
<rss version="2.0"
...
<channel>
 ...
 echo apply_filters( 'rss_update_frequency', '1' ); ?>
	...
	<?php
 do_action( 'commentsrss2_head' ); while ( have_comments() ) : the_comment(); $comment_post = get_post( $comment->comment_post_ID ); $GLOBALS['post'] = $comment_post; ?>
	<item>
		<title>
		<?php
