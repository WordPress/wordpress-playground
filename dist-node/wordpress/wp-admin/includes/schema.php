...
CREATE TABLE $wpdb->posts (
	...
	KEY user_id (user_id),
	KEY meta_key (meta_key($max_index_length))
) $charset_collate;\n"; if ( $is_multisite ) { $global_tables = $users_multi_table . $usermeta_table; } else { $global_tables = $users_single_table . $usermeta_table; } $ms_global_tables = "CREATE TABLE $wpdb->blogs (
