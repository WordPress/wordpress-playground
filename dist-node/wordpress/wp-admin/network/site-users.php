...
<?php
 do_action( 'network_site_users_after_list_table' ); if ( current_user_can( 'promote_users' ) && apply_filters( 'show_network_site_users_add_existing_form', true ) ) : ?>
...
<form action="site-users.php?action=adduser" id="adduser" method="post">
	...
	<table class="form-table" role="presentation">
		...
		<tr>
			...
			<?php
 switch_to_blog( $id ); wp_dropdown_roles( get_option( 'default_role' ) ); restore_current_blog(); ?>
			</select></td>
		</tr>
	</table>
