...
");
  ...
  var require_build2 = __commonJS({
    "node_modules/php-wasm-browser/build/index.js"(exports, module) {
      ...
      __export(src_exports, {
        ...
        initializeServiceWorker: () => initializeServiceWorker2,
        initializeWorkerThread: () => initializeWorkerThread,
        isPHPFile: () => isPHPFile2,
      ...
      function initializeServiceWorker2({
        broadcastChannel,
        shouldHandleRequest = isPHPFile2
      }) {
        if (!broadcastChannel) {
          throw new Error("Missing the required `broadcastChannel` option.");
        }
  ...
  var import_php_wasm_browser2 = __toESM(require_build2());
  ...
  (0, import_php_wasm_browser.initializeServiceWorker)({
    broadcastChannel: new BroadcastChannel("wordpress-wasm"),
    shouldHandleRequest: (url, event) => (0, import_php_wasm_browser.isPHPFile)(url.pathname) || isStaticFile(url.pathname)
  });
})();
