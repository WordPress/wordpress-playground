...
`;
      var PHP = class {
        constructor() {
          __publicField2(this, "_initPromise");
          __publicField2(this, "call");
          __publicField2(this, "stdout", []);
          __publicField2(this, "stderr", []);
          __publicField2(this, "refresh", this.clear);
        }
        ...
        async _init(PHPLoader2, _a) {
          ...
          } = _b, args = __objRest2(_b, [
            "phpIni"
          ]);
          const PHPModule = await loadPHP(PHPLoader2, __spreadValues2({
            onAbort(reason) {
      ...
      async function loadPHP(PHPLoader2, args) {
        const ModulePointer = __spreadValues2({}, args);
      ...
      var PHPServer = class {
        ...
        async dispatchToPHP(request) {
          ...
          try {
			...
			${this._setupRequestCode(__spreadProps(__spreadValues2({}, request), {
              _FILES
            }))}
...
");
      ...
      var PHPBrowser = class {
        ...
        async request(request, redirects = 0) {
          const response = await this.server.request(__spreadProps(__spreadValues2({}, request), {
  ...
  var require_build2 = __commonJS({
    "node_modules/php-wasm-browser/build/index.js"(exports, module) {
      ...
      __export(src_exports, {
        ...
        cloneResponseMonitorProgress: () => cloneResponseMonitorProgress2,
      ...
      function postMessageExpectReply2(messageTarget, message, ...postMessageArgs) {
        ...
        messageTarget.postMessage(
          __spreadProps(__spreadValues2({}, message), {
            messageId
          }),
          ...postMessageArgs
        );
      ...
      var DownloadMonitor = class extends EventTarget {
        ...
        plugIntoWebAssembly_instantiateStreaming() {
          ...
          WebAssembly.instantiateStreaming = (response, ...args) => {
            ...
            const reportingResponse = cloneResponseMonitorProgress2(
              response,
      ...
      function cloneResponseMonitorProgress2(response, onProgress) {
        ...
        async function handleMessage(message) {
          if (message.type === "initialize_php") {
            ...
            downloadMonitor.addEventListener(
              "progress",
              (e) => postMessageToParent(__spreadValues2({
          ...
          if (message.type === "request" || message.type === "httpRequest") {
            ...
            return await phpBrowser.request(__spreadProps(__spreadValues2({}, message.request), {
              path: parsedUrl.pathname,
              _GET: parsedUrl.search
            }));
          }
      ...
      async function cloneRequest(request, overrides) {
        ...
        return new Request(overrides.url || request.url, __spreadValues2({
          body,
  ...
  // packages/wordpress-wasm/build-module/example-app.js
  ...
  async function installPlugin(workerThread, pluginZipFile, options = {}) {
    ...
    const _a = Object.fromEntries(pluginFormData.entries()), { pluginzip } = _a, postData = __objRest(_a, ["pluginzip"]);
    if (options.activate) {
  ...
  var FetchProgressBar = class {
    constructor({
      ...
      __publicField(this, "onDataChunk", ({ file, loaded, total }) => {
  ...
  async function main() {
    ...
    if (preinstallPlugin) {
      const progressPluginResponse = (0, import_php_wasm_browser2.cloneResponseMonitorProgress)(
        pluginResponse,
        (progress) => progressBar.onDataChunk(__spreadValues({ file: preinstallPlugin }, progress))
      );
