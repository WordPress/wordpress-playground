  ...
  var require_build = __commonJS({
    "node_modules/php-wasm/build/index.js"(exports, module) {
      ...
      __export(src_exports, {
        PHP: () => PHP,
        PHPBrowser: () => PHPBrowser2,
        PHPServer: () => PHPServer2,
...
");
  ...
  var require_build2 = __commonJS({
    "node_modules/php-wasm-browser/build/index.js"(exports, module) {
      ...
      __export(src_exports, {
        ...
        initializeWorkerThread: () => initializeWorkerThread2,
        isPHPFile: () => isPHPFile,
      ...
      module.exports = __toCommonJS(src_exports);
      var import_php_wasm3 = require_build();
      ...
      function initializeWorkerThread2({
        assetsSizes,
        bootBrowser = ({ php, message }) => new import_php_wasm3.PHPBrowser(new import_php_wasm3.PHPServer(php, {
        ...
        async function handleMessage(message) {
          if (message.type === "initialize_php") {
            ...
            const php = new import_php_wasm3.PHP();
  ...
  var import_php_wasm2 = __toESM(require_build());
  ...
  (0, import_php_wasm_browser.initializeWorkerThread)({
    ...
    locateFile: (file) => {
      if (file.endsWith("php.wasm") || file.endsWith("php-web.js") || file.endsWith("php-webworker.js")) {
        return `${file}?${import_php_wasm2.phpWasmHash}`;
      } else if (file.endsWith("wp.data") || file.endsWith("wp.js")) {
    ...
    bootBrowser: async ({ php, workerEnv, message }) => {
      ...
      const server = new import_php_wasm.PHPServer(php, {
      ...
      return new import_php_wasm.PHPBrowser(server);
    }
  });
