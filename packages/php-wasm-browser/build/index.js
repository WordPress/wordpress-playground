...
__export(src_exports, {
  ...
  postMessageExpectReply: () => postMessageExpectReply,
...
async function defaultBootBrowser({ absoluteUrl }) {
  return new import_php_wasm.PHPBrowser(
    new import_php_wasm.PHPServer(
...
async function loadPHPWithProgress(phpLoaderModule, dataDependenciesModules = [], phpArgs2 = {}) {
  ...
  const assetsSizes = modules.reduce((acc, module2) => {
    acc[module2.dependencyFilename] = module2.dependenciesTotalSize;
    return acc;
  }, {});
  ...
  return await (0, import_php_wasm.startPHP)(
    phpLoaderModule,
