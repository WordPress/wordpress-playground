 ...
 * - "latest"
 * - "x.y" (x and y are integers) i.e. "6.2"
 * - "x.y.z" (x, y and z are integers) i.e. "6.2.1"
 * - "x.y.z-betaN" (N is an integer) i.e. "6.2.1-beta1"
 * - "x.y.z-RCN" (N is an integer) i.e. "6.2-RC1"
 *
