...
export type ContentBlockType = 'block' | 'inline' | 'ul' | 'ol' | 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6' | 'whitespace' | 'literal';
...
export class DocContentBlock extends DocNode {
	...
	public constructor(parameters: IContentBlockParameters, items?: ReadonlyArray<DocNode>) {
		super(parameters);
