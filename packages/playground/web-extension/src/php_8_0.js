const dependencyFilename = './php_8_0.wasm';
export { dependencyFilename };
export const dependenciesTotalSize = 12378163;
export function init(RuntimeName, PHPLoader) {
	...
	var Asyncify = {
		...
		handleSleep: function (startAsync) {
			...
			if (Asyncify.state === Asyncify.State.Normal) {
				...
				Asyncify.sleepCallbacks.forEach((func) =>
					callUserCallback(func)
				);
			} else {
	...
	var wasmImports = {
		Ma: _SharpYuvConvert,
		Na: _SharpYuvGetConversionMatrix,
		Oa: _SharpYuvInit,
		z: ___assert_fail,
		la: ___call_sighandler,
		aa: ___syscall_accept4,
		$: ___syscall_bind,
		Ba: ___syscall_chdir,
		H: ___syscall_chmod,
		...
		Ua: ___syscall_fallocate,
		wa: ___syscall_fchmod,
		va: ___syscall_fchown32,
		G: ___syscall_fchownat,
		...
		V: ___syscall_recvfrom,
		ia: ___syscall_renameat,
		E: ___syscall_rmdir,
		U: ___syscall_sendto,
		C: ___syscall_socket,
		sa: ___syscall_stat64,
		ha: ___syscall_statfs64,
		ga: ___syscall_symlink,
		w: ___syscall_unlinkat,
		da: ___syscall_utimensat,
		xa: __emscripten_get_now_is_monotonic,
		ba: __emscripten_throw_longjmp,
		Xa: __gmtime_js,
		Ya: __localtime_js,
		Za: __mktime_js,
		Va: __mmap_js,
		...
		k: invoke_viiiiii,
		A: invoke_viiiiiiiii,
		N: _js_create_input_device,
		Ha: _js_fd_read,
		Ga: _js_module_onMessage,
		M: _js_open_process,
		Ia: _js_popen_to_file,
		Ja: _js_process_status,
		Ka: _js_waitpid,
		Da: _proc_exit,
		K: _strftime,
		Pa: _strptime,
	...
	var ___wasm_call_ctors = function () {
		return (___wasm_call_ctors = Module['asm']['$a']).apply(
			null,
			arguments
		);
	};
	...
	var _wasm_read = (Module['_wasm_read'] = function () {
		return (_wasm_read = Module['_wasm_read'] = Module['asm']['gb']).apply(
			null,
			arguments
		);
	});
	var _fflush = (Module['_fflush'] = function () {
		return (_fflush = Module['_fflush'] = Module['asm']['hb']).apply(
			null,
			arguments
		);
	});
	...
	var _wasm_php_exec = (Module['_wasm_php_exec'] = function () {
		return (_wasm_php_exec = Module['_wasm_php_exec'] =
	...
	var _wasm_sleep = (Module['_wasm_sleep'] = function () {
		return (_wasm_sleep = Module['_wasm_sleep'] =
			Module['asm']['ob']).apply(null, arguments);
	});
	var ___wrap_select = (Module['___wrap_select'] = function () {
		return (___wrap_select = Module['___wrap_select'] =
			Module['asm']['pb']).apply(null, arguments);
	});
	var _wasm_set_sapi_name = (Module['_wasm_set_sapi_name'] = function () {
		return (_wasm_set_sapi_name = Module['_wasm_set_sapi_name'] =
	...
	var _wasm_add_ENV_entry = (Module['_wasm_add_ENV_entry'] = function () {
		return (_wasm_add_ENV_entry = Module['_wasm_add_ENV_entry'] =
	...
	var _wasm_sapi_request_shutdown = (Module['_wasm_sapi_request_shutdown'] =
		function () {
			return (_wasm_sapi_request_shutdown = Module[
	...
	var _emscripten_builtin_memalign = function () {
		return (_emscripten_builtin_memalign = Module['asm']['Jb']).apply(
			null,
			arguments
		);
	};
	var __emscripten_timeout = function () {
		return (__emscripten_timeout = Module['asm']['Kb']).apply(
			null,
			arguments
		);
	};
	...
	var dynCall_ii = (Module['dynCall_ii'] = function () {
		return (dynCall_ii = Module['dynCall_ii'] = Module['asm']['Qb']).apply(
			null,
			arguments
		);
	});
	var dynCall_vi = (Module['dynCall_vi'] = function () {
		return (dynCall_vi = Module['dynCall_vi'] = Module['asm']['Rb']).apply(
			null,
			arguments
		);
	});
	...
	var dynCall_i = (Module['dynCall_i'] = function () {
		return (dynCall_i = Module['dynCall_i'] = Module['asm']['Xb']).apply(
			null,
			arguments
		);
	});
	...
	var dynCall_v = (Module['dynCall_v'] = function () {
		return (dynCall_v = Module['dynCall_v'] = Module['asm']['$b']).apply(
			null,
			arguments
		);
	});
	...
	var _asyncify_start_unwind = function () {
		return (_asyncify_start_unwind = Module['asm']['fc']).apply(
			null,
			arguments
		);
	};
	var _asyncify_stop_unwind = function () {
		return (_asyncify_stop_unwind = Module['asm']['gc']).apply(
			null,
			arguments
		);
	};
	var _asyncify_start_rewind = function () {
		return (_asyncify_start_rewind = Module['asm']['hc']).apply(
			null,
			arguments
		);
	};
	var _asyncify_stop_rewind = function () {
		return (_asyncify_stop_rewind = Module['asm']['ic']).apply(
			null,
			arguments
		);
	};
