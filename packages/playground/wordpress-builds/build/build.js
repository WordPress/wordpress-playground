...
// build source; the shipped core bundle is the tar.zst. `trunk`/`nightly`
// are downloaded directly from GitHub as ZIP archives. The build never writes
// `src/wordpress/wp-trunk.*`, so just refresh the descriptor for those slugs.
