																...
																[
																	{
																		instancePath:
																			...
																			'/urlsMode',
																		schemaPath:
																			'#/oneOf/21/properties/urlsMode/type',
																		keyword:
																			'type',
																		params: {
																			type: 'string',
																...
																[
																	{
																		instancePath:
																			...
																			'/urlsMode',
																		schemaPath:
																			'#/oneOf/21/properties/urlsMode/enum',
																		keyword:
																			'enum',
																		params: {
																			allowedValues:
																				...
																				[
																					{
																						...
																						schemaPath:
																							'#/oneOf/21/properties/urlsMap/additionalProperties/type',
																						keyword:
																							'type',
																						params: {
																							type: 'string',
																		...
																		[
																			{
																				instancePath:
																					...
																					'/urlsMap',
																				schemaPath:
																					'#/oneOf/21/properties/urlsMap/type',
																				keyword:
																					'type',
																				params: {
																					type: 'object',
