				...
				if (!valid1) {
					...
					if (
						...
						const err0 = {
							...
							keyword: 'type',
							params: {
								type: schema25.additionalProperties.anyOf[1]
									.type,
							},
...
const schema29 = { type: 'object', additionalProperties: { type: 'string' } };
function validate28(
	data,
	{ instancePath = '', parentData, parentDataProperty, rootData = data } = {}
) {
																	...
																	if (
																		...
																		if (
																			...
																			if (
																				...
																				if (
																					data67.importStarterContent !==
																					undefined
																				) {
																					const _errs187 =
																						errors;
																					if (
																						typeof data67.importStarterContent !==
																						'boolean'
																					) {
																						validate14.errors =
																							[
													...
													if (errors === _errs328) {
														if (
															...
															if (
																...
																if (
																	data120.adminUsername !==
																	undefined
																) {
																	const _errs331 =
																		errors;
																	if (
																		typeof data120.adminUsername !==
																		'string'
																	) {
																		validate14.errors =
																			[
																...
																if (valid71) {
																	if (
																		data120.adminPassword !==
																		undefined
																	) {
																		const _errs333 =
																			errors;
																		if (
																			typeof data120.adminPassword !==
																			'string'
																		) {
																			validate14.errors =
																				[
