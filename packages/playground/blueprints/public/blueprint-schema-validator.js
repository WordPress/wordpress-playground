			...
			oneOf: [
				...
				},
				{
					...
					properties: {
						...
						step: { type: 'string', const: 'installWpCli' },
					},
					required: ['step'],
				},
				{
													...
													if (errors === _errs330) {
														if (
															...
															if (
																...
																if (
																	data121.adminUsername !==
																	undefined
																) {
																	const _errs333 =
																		errors;
																	if (
																		typeof data121.adminUsername !==
																		'string'
																	) {
																		validate14.errors =
																			[
																...
																if (valid72) {
																	if (
																		data121.adminPassword !==
																		undefined
																	) {
																		const _errs335 =
																			errors;
																		if (
																			typeof data121.adminPassword !==
																			'string'
																		) {
																			validate14.errors =
																				[
