					...
					if (
						...
						const err0 = {
							instancePath:
								...
								key0.replace(/~/g, '~0').replace(/\//g, '~1'),
							schemaPath:
								'#/additionalProperties/anyOf/1/anyOf/0/type',
							keyword: 'type',
							params: { type: 'object' },
							message: 'must be object',
						};
							...
							const err1 = {
								instancePath:
									...
									key0
										...
										.replace(/\//g, '~1'),
								schemaPath:
									'#/additionalProperties/anyOf/1/anyOf/1/type',
								keyword: 'type',
								params: { type: 'string' },
								message: 'must be string',
							};
					...
					if (!valid2) {
						const err2 = {
							instancePath:
								...
								'/' +
								key0.replace(/~/g, '~0').replace(/\//g, '~1'),
							schemaPath: '#/additionalProperties/anyOf/1/anyOf',
							keyword: 'anyOf',
							params: {},
							message: 'must match a schema in anyOf',
						};
													...
													for (const key4 in data16) {
														...
														if (
															...
															const err3 = {
																...
																schemaPath:
																	'#/definitions/PHPConstants/additionalProperties/anyOf/0/type',
																keyword: 'type',
																params: {
																	type: 'string',
																},
														...
														if (!valid10) {
															...
															if (
																...
																const err4 = {
																	...
																	schemaPath:
																		'#/definitions/PHPConstants/additionalProperties/anyOf/1/type',
																	keyword:
																		'type',
																	params: {
																		type: 'boolean',
																	...
																	const err5 =
																		{
																			...
																			schemaPath:
																				'#/definitions/PHPConstants/additionalProperties/anyOf/2/type',
																			keyword:
																				'type',
																			params: {
																				type: 'number',
														...
														if (!valid10) {
															const err6 = {
																...
																schemaPath:
																	'#/definitions/PHPConstants/additionalProperties/anyOf',
																keyword:
																	'anyOf',
																params: {},
																message:
