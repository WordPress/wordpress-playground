...
import { defaultNetworkExtensionsForExecutable } from './extension-defaults.js';

async function main(): Promise<void> {
	const argv = defaultNetworkExtensionsForExecutable(
		assertSupportedArgv(process.argv.slice(2))
	);
