<?php
/**
 * Auto-login support for Playground's browser --experimental-posix-kernel
 * mode. Mirrors the @wp-playground/wordpress 1-auto-login.php mu-plugin
 * and the CLI's wp-templates/auto-login.php.
 */
