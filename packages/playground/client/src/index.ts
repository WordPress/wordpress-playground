...
import type { PlaygroundClient } from '@wordpress/playground-remote';
import { consumeAPI } from '@wordpress/php-wasm-web';
export * from './lib';
...
export async function connectPlayground(
  ...
  const comlinkClient: Remote<PlaygroundClient> = consumeAPI<PlaygroundClient>(
