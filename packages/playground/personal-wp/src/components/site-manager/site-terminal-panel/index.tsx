...
/**
 * Compact progress state shown inside the panel while WordPress boots.
 * The website package provides a shared `InlineProgress`; Personal
 * Playground has no equivalent, so the terminal carries its own.
 */
