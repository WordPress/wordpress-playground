...
import type { PlaygroundCliWorker } from './worker-thread-v2';
// @ts-ignore
import importedWorkerUrlString from './worker-thread-v2?worker&url';
// @ts-ignore
...
export async function parseOptionsAndRunCLI() {
	let cliArgs: RunCLIArgsV2 | undefined = undefined;
	try {
		/**
...
export async function runCLI(args: RunCLIArgsV2): Promise<RunCLIServer> {
