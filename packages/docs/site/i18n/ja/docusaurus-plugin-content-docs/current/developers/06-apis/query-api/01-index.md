...
| オプション      | デフォルト値          | 説明                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| --------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `php`           | `8.3`                 | 指定された PHP バージョンをロードします。 `7.4`, `8.0`, `8.1`, `8.2`, `8.3`, `8.4`, `8.5`, `latest`, or `next`.                                                                                                                                                                                                                                                                                                                                                                                                     |
| `wp`            | `latest`              | 指定された WordPress バージョンを読み込みます。`6.3` から `7.0` など、サポートされている WordPress リリースラインを使用できます。また、汎用的な値として`latest`、`nightly`、`beta`も使用できます。                                                                                                                                                                                                                                                                                                                  |
...
`php`、`wp`、`login`、`url`、`networking`、`multisite`、`plugin`、`theme`、
`import-wxr` などのクエリパラメータは、`blueprint-url` または URL
フラグメントから読み込まれた Blueprint にも適用されます。Blueprint v2
宣言も対象です。`import-site` は現在、Query API v1 の Blueprint でのみ
サポートされています。

<!--
| Option                   | Default Value         | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------ | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `php`                    | `8.3`                 | Loads the specified PHP version. Accepts `7.4`, `8.0`, `8.1`, `8.2`, `8.3`, `8.4`, `8.5`, `latest`, or `next`.                                                                                                                                                                                                                                                                                                                                         |
| `wp`                     | `latest`              | Loads the specified WordPress version. Accepts supported WordPress release lines such as `6.3` through `7.0`. You can also use the generic values `latest`, `nightly`, or `beta`.                                                                                                                                                                                                                                                                                          |
