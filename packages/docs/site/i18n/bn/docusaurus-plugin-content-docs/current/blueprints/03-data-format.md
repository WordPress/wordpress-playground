...
- `php` (string): নির্দিষ্ট PHP সংস্করণ লোড করে। `7.4`, `8.0`, `8.1`, `8.2`, `8.3`, `8.4`, `8.5`, `latest`, বা `next` গ্রহণ করে। `7.4.1` এর মতো মাইনর সংস্করণ সমর্থিত নয়।
- `wp` (string): নির্দিষ্ট WordPress সংস্করণ লোড করে। `6.3` থেকে `7.0` পর্যন্ত সমর্থিত WordPress রিলিজ লাইন গ্রহণ করে। আপনি জেনেরিক মান `latest`, `nightly`, বা `beta` ও ব্যবহার করতে পারেন। WordPress এর একটি প্রি-রিলিজ সংস্করণ ব্যবহার করতে, `beta` একটি রিলিজ সাইকেলের সর্বশেষ বিটা বা রিলিজ ক্যান্ডিডেট সংস্করণ লোড করবে (Beta বা RC)।
