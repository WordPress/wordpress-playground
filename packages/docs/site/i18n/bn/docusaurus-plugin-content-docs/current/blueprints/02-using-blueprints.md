...
JavaScript-এ, আপনি গ্লোবাল ফাংশন <code>btoa()</code> দিয়ে <a href="https://developer.mozilla.org/en-US/docs/Glossary/Base64#javascript_support">Base64 ফরম্যাটে</a> যেকোনো blueprint JSON পেতে পারেন।
