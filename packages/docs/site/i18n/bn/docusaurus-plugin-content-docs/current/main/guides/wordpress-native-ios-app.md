...
description: প্লেগ্রাউন্ড ব্যবহার করে "Blocknotes" কেস স্টাডির ওপর ভিত্তি করে কিভাবে একটি নেটিভ iOS অ্যাপের মধ্যে ওয়ার্ডপ্রেস সাইট চালানো যায় তা জানুন।
---
...
Blocknotes হলো প্রথম iOS অ্যাপ্লিকেশন যা ওয়ার্ডপ্রেস প্লেগ্রাউন্ড ব্যবহার করে iOS ডিভাইসে নেটিভভাবে ওয়ার্ডপ্রেস চালিয়েছিল। ওয়ার্ডপ্রেসের একজন কোর কমিটার [Ella van Durpe](https://profiles.wordpress.org/ellatrix/) দ্বারা ডেভেলপ করা Blocknotes একটি ট্র্যাডিশনাল PHP সার্ভারের প্রয়োজন ছাড়াই ওয়ার্ডপ্রেস চালানোর জন্য ওয়েবঅ্যাসেম্বলি (WebAssembly) ব্যবহার করে মোবাইল অ্যাপ্লিকেশনের সক্ষমতায় একটি উল্লেখযোগ্য অগ্রগতি প্রদর্শন করে।
...
এই কেস স্টাডিটি মোবাইল এবং ওয়েব ডেভেলপমেন্টের ভবিষ্যতের জন্য Blocknotes-এর বৈশিষ্ট্য, টেকনিক্যাল ইমপ্লিমেন্টেশন এবং এর সম্ভাব্য প্রভাবগুলো অন্বেষণ করে।
...
**গুরুত্বপূর্ণ!** Blocknotes-এর বর্তমান ভার্সনে এখন আর ওয়ার্ডপ্রেস প্লেগ্রাউন্ড চলছে না। প্রাথমিক রিলিজের পর, অ্যাপটিকে ওয়ার্ডপ্রেসের বাকি অংশ ছাড়াই শুধুমাত্র ওয়ার্ডপ্রেস ব্লক এডিটর ব্যবহার করার জন্য নতুন করে লেখা হয়েছে। এই কেস স্টাডিটি Blocknotes-এর প্রাথমিক ভার্সনগুলোকে কভার করে যা ওয়ার্ডপ্রেসের জন্য নতুন সম্ভাবনার এক বিশাল জগত উন্মোচন করেছিল।

<!--
## Blocknotes features
-->

## Blocknotes-এর বৈশিষ্ট্যসমূহ
...
Blocknotes ব্যবহারকারীদের ওয়ার্ডপ্রেস ব্লক এডিটর ব্যবহার করে নোট তৈরি এবং এডিট করার অনুমতি দেয়। নোটগুলো স্বয়ংক্রিয়ভাবে ইউজারের iCloud ড্রাইভে HTML ফাইল হিসেবে সেভ হয় এবং নিরবিচ্ছিন্নভাবে সব ডিভাইসে সিনক্রোনাইজ হয়ে যায়।
...
[Blocknotes GitHub রিপোজিটরিতে](https://github.com/blocknotes-org/blocknotes/tree/e08535883332be9a45a0c75b750c54a4e17f6748) আপনি সর্বশেষ প্লেগ্রাউন্ড-ভিত্তিক রিলিজটি রিভিউ করতে পারেন। এখানে সবচেয়ে গুরুত্বপূর্ণ অংশগুলো রয়েছে:
...
যদিও Blocknotes প্রমাণ করেছে যে ওয়ার্ডপ্রেস-ভিত্তিক iOS অ্যাপ রিলিজ করা সম্ভব, তবে এটি এখনও একটি উচ্চমাত্রার অনুসন্ধানী এলাকা। এখানে কোনো প্রতিষ্ঠিত ওয়ার্কফ্লো, লাইব্রেরি বা নলেজ বেস নেই।
...
Blocknotes এক নতুন প্রজন্মের অ্যাপ্লিকেশনের পথ প্রশস্ত করে যা আরও অ্যাক্সেসযোগ্য, ফ্লেক্সিবল এবং শক্তিশালী।
