...
- [একটি নতুন ওয়ার্ডপ্রেস সাইট শুরু করুন](#একটি-নতুন-ওয়ার্ডপ্রেস-সাইট-শুরু-করুন)
- [একটি ব্লক, থিম বা প্লাগইন ট্রাই করুন](#একটি-ব্লক-থিম-বা-প্লাগইন-ট্রাই-করুন)
- [আপনার সাইটটি সংরক্ষণ করুন](#আপনার-সাইটটি-সংরক্ষণ-করুন)
- [একটি সংরক্ষিত সাইট রিস্টোর করুন](#একটি-সংরক্ষিত-সাইট-রিস্টোর-করুন)
- [একটি নির্দিষ্ট ওয়ার্ডপ্রেস বা PHP সংস্করণ ব্যবহার করুন](#একটি-নির্দিষ্ট-ওয়ার্ডপ্রেস-বা-php-সংস্করণ-ব্যবহার-করুন)
- [একটি WXR ফাইল ইমপোর্ট করুন](#একটি-wxr-ফাইল-ইমপোর্ট-করুন)
- [ওয়ার্ডপ্রেস প্লেগ্রাউন্ড দিয়ে অ্যাপ তৈরি করুন](#ওয়ার্ডপ্রেস-প্লেগ্রাউন্ড-দিয়ে-অ্যাপ-তৈরি-করুন)
...
<strong>ওয়ার্ডপ্রেস প্লেগ্রাউন্ড ব্যক্তিগত</strong>
...
<strong>আপনার প্লাগইন বা থিম পরীক্ষা করুন</strong>
...
<strong>শুধুমাত্র মেজর সংস্করণগুলো</strong>

আপনি <code>wp=6.2</code> বা <code>php=8.1</code>-এর মতো মেজর সংস্করণগুলো নির্দিষ্ট করতে পারেন এবং সেই লাইনের সাম্প্রতিক রিলিজটি আশা করতে পারেন। তবে, আপনি পুরনো মাইনর সংস্করণগুলোর অনুরোধ করতে পারবেন না, তাই <code>wp=6.1.2</code> বা <code>php=7.4.9</code> কাজ করবে না।
