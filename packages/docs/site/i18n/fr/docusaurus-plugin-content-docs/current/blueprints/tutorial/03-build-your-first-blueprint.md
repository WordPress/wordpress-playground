...
<strong>Auto-complétion</strong>

Si vous utilisez un IDE tel que VS Code ou PHPStorm, vous pouvez utiliser le <a href="https://playground.wordpress.net/blueprint-schema.json">Schéma JSON Blueprint</a> pour activer l'auto-complétion pendant votre développement. Ajoutez la ligne qui suit au début de votre fichier <code>blueprint.json</code> :
