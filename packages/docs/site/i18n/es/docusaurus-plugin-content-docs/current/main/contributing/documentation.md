...
El [sitio de documentación de WordPress Playground](/) lo mantienen voluntarios como tú, que agradecerían tu ayuda.
...
Puedes contribuir [abriendo una incidencia en el repositorio del proyecto](https://github.com/WordPress/wordpress-playground/issues/new) y describiendo lo que te gustaría añadir o cambiar.

<!--
If you feel up to it, write the content in the issue description, and the project contributors will take care of the rest.
-->

Si te animas, escribe el contenido en la descripción de la incidencia y los contribuidores del proyecto se encargarán del resto.
...
### Bifurcar el repositorio, editar archivos localmente y abrir pull requests
...
Si estás familiarizado con markdown, puedes [bifurcar](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/fork-a-repo) el repositorio `wordpress-playground` y proponer cambios y nuevas páginas de documentación enviando un pull request.
...
Si has iniciado sesión en GitHub, también puedes editar archivos existentes (o añadir otros nuevos) y enviar un PR directamente desde la interfaz de usuario de GitHub:
...
1. Busca la página que te gustaría editar o el directorio del capítulo al que te gustaría añadir una nueva página.
...
3. GitHub te pedirá que bifurques el repositorio y crees una nueva rama con tus cambios.
4. Se abrirá un editor en el que podrás hacer los cambios.
5. Cuando hayas terminado, haz clic en el botón **Confirmar cambios** y envía un pull request.
...
La desventaja es que no podrás previsualizar tus cambios. Sigue leyendo para aprender cómo revisar tus cambios antes de enviar un pull request.
...
Clona el repositorio y navega hasta el directorio en tu dispositivo. Ahora ejecuta los siguientes comandos:
...
El sitio de documentación se abre en una nueva pestaña del navegador y se actualiza automáticamente con cada cambio. Continúa editando el archivo correspondiente en tu editor de código y prueba los cambios en tiempo real.
