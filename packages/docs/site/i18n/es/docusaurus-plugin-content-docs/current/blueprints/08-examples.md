...
Consulta la <a href="https://github.com/WordPress/blueprints/blob/trunk/GALLERY.md">Galería de Blueprints</a> para explorar ejemplos de código del mundo real usando WordPress Playground para lanzar un sitio WordPress con una variedad de configuraciones.
