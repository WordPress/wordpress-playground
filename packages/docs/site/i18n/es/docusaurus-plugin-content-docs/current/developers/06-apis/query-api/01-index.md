...
Para importar archivos desde una URL, como un paquete zip del sitio, deben servirse con el encabezado <code>Access-Control-Allow-Origin</code> configurado. Consulta: <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS#the_http_response_headers">Cross-Origin Resource Sharing (CORS)</a>.
