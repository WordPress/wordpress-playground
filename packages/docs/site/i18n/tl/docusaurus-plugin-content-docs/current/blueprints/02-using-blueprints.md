...
Sa JavaScript, Maaari kang makakuha ng anumang blueprint JSON sa <a href="https://developer.mozilla.org/en-US/docs/Glossary/Base64#javascript_support">Base64 format</a> gamit ang global function na <code>btoa()</code>.
