...
Kung hindi ka sigurado sa mga hakbang sa itaas, bisitahin ang opisyal na <a href="https://developer.wordpress.org/block-editor/contributors/">Gutenberg Project Contributor Guide</a>. Tandaan na sa pagkakataong ito, papalitan ng `wp-now` ang `wp-env`.
