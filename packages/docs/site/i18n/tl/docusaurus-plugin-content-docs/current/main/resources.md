---
title: Mga Link at Resources
slug: /links-and-resources
description: Isang piniling listahan ng mga kapaki-pakinabang na link sa mga app, tool, artikulo, at video para matuto pa tungkol sa WordPress Playground.
---
...
<ul id="list-resources-redirections">
<li><a target="_blank" rel="noopener noreferrer" href="https://playground.wordpress.net/"><strong>playground.wordpress.net/</strong></a> → Instansiya ng Playground</li>
<li><a target="_blank" rel="noopener noreferrer" href="https://playground.wordpress.net/docs">playground.wordpress.net<strong>/docs</strong></a> → Dokumentasyon ng Playground</li>
<li><a target="_blank" rel="noopener noreferrer" href="https://playground.wordpress.net/builder">playground.wordpress.net<strong>/builder</strong></a> → Blueprint Builder ng Playground</li>
<li><a target="_blank" rel="noopener noreferrer" href="https://playground.wordpress.net/wordpress">playground.wordpress.net<strong>/wordpress</strong></a> → Pang-preview ng pull request sa Playground para sa WordPress</li>
<li><a target="_blank" rel="noopener noreferrer" href="https://playground.wordpress.net/gutenberg">playground.wordpress.net<strong>/gutenberg</strong></a> → Pang-preview ng pull request sa Playground para sa Gutenberg</li>
</ul>
...
- [Demo](https://playground.wordpress.net/)
- [Repositori sa GitHub](https://github.com/WordPress/wordpress-playground)
- [Dokumentasyon](https://wordpress.github.io/wordpress-playground/)
- [Repositori ng mga tool ng Playground](https://github.com/WordPress/playground-tools)
- [Awesome WordPress Playground](https://github.com/akirk/awesome-wordpress-playground) – listahan ng mga resource, tool, at halimbawang pinili ng komunidad
...
## Mga App na Ginawa Gamit ang WordPress Playground {#apps-built-with-wordpress-playground}

- [Opisyal na demo](https://playground.wordpress.net/) at ang [app na nagpapakita ng mga halimbawa](https://developer.wordpress.org/playground) – mag-install ng tema, subukan ang plugin, gumawa ng ilang pahina, at i-export ang ginawa mo
- [@wp-playground/cli](https://www.npmjs.com/package/@wp-playground/cli) – CLI tool para sa agarang kapaligiran sa pag-develop ng WordPress
...
- Mga live na pagsasalin: [app](https://translate.wordpress.org/projects/wp-plugins/friends/dev/pl/default/playground/), [anunsyo](https://make.wordpress.org/polyglots/2023/04/19/wp-translation-playground/), [higit pang detalye](https://make.wordpress.org/polyglots/2023/05/08/translate-live-updates-to-the-translation-playground/)
- [Interaktibong bloke ng code](https://wordpress.org/plugins/interactive-code-block/) na nagpapatakbo ng [tutorial sa HTML Tag Processor](https://adamadam.blog/2023/02/16/how-to-modify-html-in-a-php-wordpress-plugin-using-the-new-tag-processor-api/) at [tutorial sa Playground JS API](https://wordpress.github.io/wordpress-playground/developers/apis/javascript-api/)
- [Pang-preview ng pull request sa Gutenberg](https://playground.wordpress.net/gutenberg.html)
- [GraphQL REPL](https://www.wpgraphql.com/2023/06/15/announcing-the-wpgraphql-repl)
...
- [Mga demo ng plugin sa wp.org](https://gist.github.com/adamziel/0fe3ffc1fb5202a907a87d055ee37135) – script ng user na nagdaragdag ng tab na "demo" sa mga pahina ng plugin sa WordPress.org
- [Pang-preview ng pull request sa WordPress](https://playground.wordpress.net/wordpress.html)
- [Pag-synchronize sa pagitan ng dalawang Playground](https://playground.wordpress.net/demos/sync.html)
- [Time Travel](https://playground.wordpress.net/demos/time-traveling.html)
- [WP-CLI](https://playground.wordpress.net/demos/wp-cli.html)
- [Implementasyon ng Blueprints sa PHP](https://playground.wordpress.net/demos/php-blueprints.html)
...
- [Bumuo ng mga karanasang WordPress sa browser gamit ang WordPress Playground at WebAssembly](https://web.dev/wordpress-playground/)
- [WordPress Playground sa developer.wordpress.org](https://developer.wordpress.org/playground)
- [Mga teknikal na demo ng WordPress sa browser: pag-develop ng WordPress gamit ang WordPress Playground](https://make.wordpress.org/core/2023/04/13/in-browser-wordpress-tech-demos-wordpress-development-with-wordpress-playground/)
- [Unang anunsyo sa make.wordpress.org](https://make.wordpress.org/core/2022/09/23/client-side-webassembly-wordpress-with-no-server/)
- [Diskusyon sa Hackernews](https://news.ycombinator.com/item?id=32960560)
