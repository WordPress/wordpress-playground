...
Confira a [Galeria de Blueprints](https://wordpress.github.io/blueprints/) para explorar exemplos de código do mundo real usando o WordPress Playground para lançar um site WordPress com uma variedade de configurações.
