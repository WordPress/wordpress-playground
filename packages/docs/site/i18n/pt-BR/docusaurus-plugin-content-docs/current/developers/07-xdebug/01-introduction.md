...
Para um início rápido, confira o [guia de primeiros passos com Xdebug](/developers/xdebug/xdebug-getting-started) es
...
**Próximo**: [Primeiros Passos com Xdebug →](/developers/xdebug/xdebug-getting-started)
