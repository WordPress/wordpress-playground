...
<strong>Política de CORS</strong>
...
Para importar arquivos de uma URL, como um pacote zip de site, eles devem ser servidos com o cabeçalho <code>Access-Control-Allow-Origin</code> configurado. Para referência, veja: <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS#the_http_response_headers">Cross-Origin Resource Sharing (CORS)</a>.
