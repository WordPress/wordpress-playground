...
તમે તમારા ડેવલપમેન્ટ વર્કફ્લોમાં પ્લેગ્રાઉન્ડને સરળતાથી ઇન્ટિગ્રેટ કરી શકો છો,
જેથી કોડ ટેસ્ટ કરવા માટે તમે ઝડપથી લોકલ વર્ડપ્રેસ એન્વાયરમેન્ટ લોન્ચ કરી શકો.

તમે આ સીધા જ [ટર્મિનલમાંથી](/developers/local-development/wp-playground-cli) અથવા [તમારા પસંદગીના IDE](/developers/local-development/vscode-extension) માંથી કરી શકો છો.
...
![સ્ટોરેજ ટાઈપ ડિવાઈસ સ્નેપશોટ](../_assets/storage-type-device.png)
