...
<ul id="list-resources-redirections">
<li>[**https://playground.wordpress.net/**](https://playground.wordpress.net/) → istanza Playground</li>
<li>[https://playground.wordpress.net**/docs**](https://playground.wordpress.net/docs) → documentazione di Playground</li>
