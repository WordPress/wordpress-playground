...
WordPress Playground è composto dai seguenti componenti di alto livello:
...
- [Pacchetti PHP.wasm](/developers/architecture/php-wasm-packages) per l'API
  condivisa, i binding di piattaforma e i binari specifici per ogni versione
...
per un bundler come Webpack, e NX gestisce questa complessità molto meglio:
![Grafo delle dipendenze](https://raw.githubusercontent.com/WordPress/wordpress-playground/refs/heads/trunk/packages/docs/site/static/img/dependencies.webp)
...
contemporaneamente: incrementa il numero di versione, imposta un nuovo tag e
...
si aggiorna un singolo pacchetto, Lerna incrementa il numero di versione di
tutti i pacchetti che ne dipendono.
