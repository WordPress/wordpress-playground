...
| `can-save`         |                       | Controls whether the Dock shows persistence controls. Use `can-save=no` to hide browser-storage, local-directory, autosave, and store-permanently controls from the UI.                                                                                                                                                                                                                                                                                                     |
