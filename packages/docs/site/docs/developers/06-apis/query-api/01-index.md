...
| `filebrowser`      |                       | Opens the Dock’s **Files** pane. Accepts an optional file path relative to the WordPress document root, and an optional `:<line>` suffix to place the editor cursor on a 1-based line.                                                                                                                                                                                                                                                                                      |
