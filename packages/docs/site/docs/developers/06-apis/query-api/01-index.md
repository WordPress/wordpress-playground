...
| ------------------ | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `php`              | `8.3`                 | Loads the specified PHP version. Accepts `7.4`, `8.0`, `8.1`, `8.2`, `8.3`, `8.4`, `8.5`, `latest`, or `next`. Use `next` to preview the next PHP version from the php-src development branch; it is currently supported by the web runtime only.                                                                                                                                                                                                                           |
...
| `wp`               | `latest`              | Loads the specified WordPress version. Accepts supported WordPress release lines such as `6.3` through `6.9`. You can also use the generic values `latest`, `nightly`, or `beta`.                                                                                                                                                                                                                                                                                           |
