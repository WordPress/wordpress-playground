...
For a quick start, check the [getting started with Xdebug guide](/developers/xdebug/xdebug-getting-started)
...
**Next**: [Getting Started with Xdebug →](/developers/xdebug/xdebug-getting-started)
