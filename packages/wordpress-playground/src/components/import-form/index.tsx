		...
		<div className={css.modalInner}>
			...
			>
				...
				<p className={css.modalText}>
					You may import a previously exported WordPress
					Playground instance here.
				</p>
				<p className={css.modalText}>
					...
					<ul className={css.modalTextList}>
						<li>
							Styling changes may take up to one minute to
							update.
						</li>
						<br />
						<li>
							Migrating between different WordPress versions
							is not supported.
						</li>
						<br />
						<li>
							Media files, options/users, and plugin state
