...
extern void *js_open_process(const char *command, char **args, int args_length, int procopen_call_nb, int out_childend, int out_parentend, int err_childend, int err_parentend);
