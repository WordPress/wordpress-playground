...
export const dependenciesTotalSize = 6332871;
...
/** not-t@type {!BigUint64Array} */ HEAPU64,
	...
	var _flock = (Module['_flock'] = (a0, a1) =>
		(_flock = Module['_flock'] = wasmExports['qb'])(a0, a1));
	...
	var ___wrap_select = (Module['___wrap_select'] = (a0, a1, a2, a3, a4) =>
		(___wrap_select = Module['___wrap_select'] = wasmExports['Ab'])(
			a0,
			a1,
			a2,
			a3,
	...
	var _wasm_set_cookies = (Module['_wasm_set_cookies'] = (a0) =>
		(_wasm_set_cookies = Module['_wasm_set_cookies'] = wasmExports['Qb'])(
			a0
		));
	...
	var _php_wasm_init = (Module['_php_wasm_init'] = () =>
		(_php_wasm_init = Module['_php_wasm_init'] = wasmExports['Ub'])());

	var _wasm_free = (Module['_wasm_free'] = (a0) =>
		(_wasm_free = Module['_wasm_free'] = wasmExports['Vb'])(a0));
