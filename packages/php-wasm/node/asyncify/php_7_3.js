...
export const dependenciesTotalSize = 14262166;
export function init(RuntimeName, PHPLoader) {
	...
	var _wasm_popen = (Module['_wasm_popen'] = (a0, a1) =>
		(_wasm_popen = Module['_wasm_popen'] = wasmExports['db'])(a0, a1));

	var _wasm_php_exec = (Module['_wasm_php_exec'] = (a0, a1, a2, a3) =>
		(_wasm_php_exec = Module['_wasm_php_exec'] = wasmExports['eb'])(
			a0,
			a1,
			a2,
			a3
	...
	var _wasm_sleep = (Module['_wasm_sleep'] = (a0) =>
		(_wasm_sleep = Module['_wasm_sleep'] = wasmExports['jb'])(a0));
	...
	var dynCall_viiiii = (Module['dynCall_viiiii'] = (a0, a1, a2, a3, a4, a5) =>
		(dynCall_viiiii = Module['dynCall_viiiii'] = wasmExports['Xb'])(
			a0,
			a1,
			a2,
			a3,
