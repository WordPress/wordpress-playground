...
export const dependenciesTotalSize = 18513181;
...
/** not-t@type {!BigUint64Array} */ HEAPU64,
	...
	var wasmImports = {
		...
		/** @export */ Z: _js_release_file_locks,
	...
	var _flock = (Module['_flock'] = (a0, a1) =>
		(_flock = Module['_flock'] = wasmExports['nb'])(a0, a1));
