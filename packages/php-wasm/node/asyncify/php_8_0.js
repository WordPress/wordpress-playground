...
export const dependenciesTotalSize = 14453732;
export function init(RuntimeName, PHPLoader) {
	...
	var wasmImports = {
		/** @export */ $a: _SharpYuvConvert,
		/** @export */ _a: _SharpYuvGetConversionMatrix,
		/** @export */ Za: _SharpYuvInit,
		...
		/** @export */ aa: ___syscall_fallocate,
	...
	var _htons = (a0) => (_htons = wasmExports['kb'])(a0);

	var _ntohs = (a0) => (_ntohs = wasmExports['lb'])(a0);

	var _htonl = (a0) => (_htonl = wasmExports['mb'])(a0);

	var _wasm_sleep = (Module['_wasm_sleep'] = (a0) =>
		(_wasm_sleep = Module['_wasm_sleep'] = wasmExports['nb'])(a0));
	...
	var dynCall_viiiiiiiii = (Module['dynCall_viiiiiiiii'] = (
		...
		(dynCall_viiiiiiiii = Module['dynCall_viiiiiiiii'] = wasmExports['dc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_viiiiiii = (Module['dynCall_viiiiiii'] = (
		...
		(dynCall_viiiiiii = Module['dynCall_viiiiiii'] = wasmExports['ec'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_jii = (Module['dynCall_jii'] = (a0, a1, a2) =>
		(dynCall_jii = Module['dynCall_jii'] = wasmExports['ic'])(a0, a1, a2));

	var dynCall_viidii = (Module['dynCall_viidii'] = (a0, a1, a2, a3, a4, a5) =>
		(dynCall_viidii = Module['dynCall_viidii'] = wasmExports['jc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var _asyncify_start_unwind = (a0) =>
		(_asyncify_start_unwind = wasmExports['kc'])(a0);

	var _asyncify_stop_unwind = () =>
		(_asyncify_stop_unwind = wasmExports['lc'])();

	var _asyncify_start_rewind = (a0) =>
		(_asyncify_start_rewind = wasmExports['mc'])(a0);

	var _asyncify_stop_rewind = () =>
		(_asyncify_stop_rewind = wasmExports['nc'])();
