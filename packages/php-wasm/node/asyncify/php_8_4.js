...
export const dependenciesTotalSize = 21820257;
...
/** not-t@type {!BigUint64Array} */ HEAPU64,
	...
	var wasmImports = {
		...
		/** @export */ lb: ___call_sighandler,
		/** @export */ Y: ___cxa_throw,
		/** @export */ kb: ___syscall_accept4,
		/** @export */ jb: ___syscall_bind,
		/** @export */ ib: ___syscall_chdir,
		/** @export */ X: ___syscall_chmod,
		/** @export */ hb: ___syscall_connect,
		/** @export */ gb: ___syscall_dup,
		/** @export */ fb: ___syscall_dup3,
		/** @export */ eb: ___syscall_faccessat,
		/** @export */ db: ___syscall_fallocate,
		/** @export */ cb: ___syscall_fchmod,
		/** @export */ bb: ___syscall_fchown32,
		/** @export */ W: ___syscall_fchownat,
		/** @export */ o: ___syscall_fcntl64,
		/** @export */ ab: ___syscall_fdatasync,
		/** @export */ $a: ___syscall_fstat64,
		/** @export */ _a: ___syscall_ftruncate64,
		/** @export */ Za: ___syscall_getcwd,
		/** @export */ Ya: ___syscall_getdents64,
		/** @export */ Xa: ___syscall_getpeername,
		/** @export */ Wa: ___syscall_getsockname,
		/** @export */ Va: ___syscall_getsockopt,
		/** @export */ G: ___syscall_ioctl,
		/** @export */ Ua: ___syscall_listen,
		/** @export */ Ta: ___syscall_lstat64,
		/** @export */ Sa: ___syscall_mkdirat,
		/** @export */ Ra: ___syscall_newfstatat,
		/** @export */ z: ___syscall_openat,
		/** @export */ Qa: ___syscall_pipe,
		/** @export */ Pa: ___syscall_poll,
		/** @export */ Oa: ___syscall_readlinkat,
		/** @export */ Na: ___syscall_recvfrom,
		/** @export */ Ma: ___syscall_renameat,
		/** @export */ V: ___syscall_rmdir,
		/** @export */ La: ___syscall_sendto,
		/** @export */ U: ___syscall_socket,
		/** @export */ Ka: ___syscall_stat64,
		/** @export */ Ja: ___syscall_statfs64,
		/** @export */ Ia: ___syscall_symlinkat,
		/** @export */ F: ___syscall_unlinkat,
		/** @export */ Ha: ___syscall_utimensat,
		/** @export */ Aa: __abort_js,
		/** @export */ za: __emscripten_lookup_name,
		/** @export */ ya: __emscripten_runtime_keepalive_clear,
		/** @export */ xa: __emscripten_throw_longjmp,
		/** @export */ wa: __gmtime_js,
		/** @export */ va: __localtime_js,
		/** @export */ ua: __mktime_js,
		/** @export */ ta: __mmap_js,
		/** @export */ sa: __munmap_js,
		/** @export */ R: __setitimer_js,
		/** @export */ ra: __tzset_js,
		/** @export */ Ga: _clock_time_get,
		/** @export */ Q: _emscripten_date_now,
		/** @export */ qa: _emscripten_get_heap_max,
		...
		/** @export */ oa: _getcontext,
		/** @export */ na: _getdtablesize,
		/** @export */ x: _getnameinfo,
		/** @export */ ma: _getprotobyname,
		/** @export */ la: _getprotobynumber,
		/** @export */ l: invoke_i,
		/** @export */ c: invoke_ii,
		/** @export */ b: invoke_iii,
		/** @export */ g: invoke_iiii,
		/** @export */ h: invoke_iiiii,
		/** @export */ n: invoke_iiiiii,
		/** @export */ v: invoke_iiiiiii,
		/** @export */ w: invoke_iiiiiiii,
		/** @export */ N: invoke_iiiiiiiiii,
		/** @export */ D: invoke_iij,
		/** @export */ M: invoke_iiji,
		/** @export */ ka: invoke_iijii,
		/** @export */ ja: invoke_iijiji,
		/** @export */ L: invoke_jii,
		...
		/** @export */ da: _js_release_file_locks,
		/** @export */ ca: _js_waitpid,
		/** @export */ ba: _js_wasm_trace,
		/** @export */ aa: _makecontext,
		/** @export */ Ba: _proc_exit,
		/** @export */ $: _strptime,
		/** @export */ _: _swapcontext,
		/** @export */ t: _wasm_close,
		/** @export */ u: wasm_poll_socket,
		/** @export */ q: _wasm_setsockopt,
		/** @export */ Z: _wasm_shutdown,
	};
	...
	var _getpid = (Module['_getpid'] = () =>
		(_getpid = Module['_getpid'] = wasmExports['rb'])());
	...
	var _htons = (a0) => (_htons = wasmExports['vb'])(a0);

	var _ntohs = (a0) => (_ntohs = wasmExports['wb'])(a0);

	var _htonl = (a0) => (_htonl = wasmExports['xb'])(a0);

	var _wasm_sleep = (Module['_wasm_sleep'] = (a0) =>
		(_wasm_sleep = Module['_wasm_sleep'] = wasmExports['yb'])(a0));

	var _fflush = (a0) => (_fflush = wasmExports['zb'])(a0);

	var _flock = (Module['_flock'] = (a0, a1) =>
		(_flock = Module['_flock'] = wasmExports['Ab'])(a0, a1));

	var _wasm_read = (Module['_wasm_read'] = (a0, a1, a2) =>
		(_wasm_read = Module['_wasm_read'] = wasmExports['Bb'])(a0, a1, a2));

	var ___wrap_select = (Module['___wrap_select'] = (a0, a1, a2, a3, a4) =>
		(___wrap_select = Module['___wrap_select'] = wasmExports['Cb'])(
			a0,
			a1,
			a2,
			a3,
	...
	var _wasm_add_cli_arg = (Module['_wasm_add_cli_arg'] = (a0) =>
		(_wasm_add_cli_arg = Module['_wasm_add_cli_arg'] = wasmExports['Fb'])(
			a0
		));

	var _run_cli = (Module['_run_cli'] = () =>
		(_run_cli = Module['_run_cli'] = wasmExports['Gb'])());
	...
	var _wasm_set_cookies = (Module['_wasm_set_cookies'] = (a0) =>
		(_wasm_set_cookies = Module['_wasm_set_cookies'] = wasmExports['Sb'])(
			a0
		));
	...
	var _php_wasm_init = (Module['_php_wasm_init'] = () =>
		(_php_wasm_init = Module['_php_wasm_init'] = wasmExports['Wb'])());

	var _wasm_free = (Module['_wasm_free'] = (a0) =>
		(_wasm_free = Module['_wasm_free'] = wasmExports['Xb'])(a0));
	...
	var _wasm_trace = (Module['_wasm_trace'] = (a0, a1) =>
		(_wasm_trace = Module['_wasm_trace'] = wasmExports['Zb'])(a0, a1));

	var ___funcs_on_exit = () => (___funcs_on_exit = wasmExports['_b'])();

	var _emscripten_builtin_memalign = (a0, a1) =>
		(_emscripten_builtin_memalign = wasmExports['$b'])(a0, a1);

	var __emscripten_timeout = (a0, a1) =>
		(__emscripten_timeout = wasmExports['ac'])(a0, a1);

	var _setThrew = (a0, a1) => (_setThrew = wasmExports['bc'])(a0, a1);

	var __emscripten_stack_restore = (a0) =>
		(__emscripten_stack_restore = wasmExports['cc'])(a0);

	var __emscripten_stack_alloc = (a0) =>
		(__emscripten_stack_alloc = wasmExports['dc'])(a0);

	var _emscripten_stack_get_current = () =>
		(_emscripten_stack_get_current = wasmExports['ec'])();

	var dynCall_iiii = (Module['dynCall_iiii'] = (a0, a1, a2, a3) =>
		(dynCall_iiii = Module['dynCall_iiii'] = wasmExports['fc'])(
			a0,
			a1,
			a2,
			a3
	...
	var dynCall_ii = (Module['dynCall_ii'] = (a0, a1) =>
		(dynCall_ii = Module['dynCall_ii'] = wasmExports['gc'])(a0, a1));

	var dynCall_vi = (Module['dynCall_vi'] = (a0, a1) =>
		(dynCall_vi = Module['dynCall_vi'] = wasmExports['hc'])(a0, a1));

	var dynCall_vii = (Module['dynCall_vii'] = (a0, a1, a2) =>
		(dynCall_vii = Module['dynCall_vii'] = wasmExports['ic'])(a0, a1, a2));

	var dynCall_viiiii = (Module['dynCall_viiiii'] = (a0, a1, a2, a3, a4, a5) =>
		(dynCall_viiiii = Module['dynCall_viiiii'] = wasmExports['jc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_iii = (Module['dynCall_iii'] = (a0, a1, a2) =>
		(dynCall_iii = Module['dynCall_iii'] = wasmExports['kc'])(a0, a1, a2));

	var dynCall_iiiii = (Module['dynCall_iiiii'] = (a0, a1, a2, a3, a4) =>
		(dynCall_iiiii = Module['dynCall_iiiii'] = wasmExports['lc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_iiiiii = (Module['dynCall_iiiiii'] = (a0, a1, a2, a3, a4, a5) =>
		(dynCall_iiiiii = Module['dynCall_iiiiii'] = wasmExports['mc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_viii = (Module['dynCall_viii'] = (a0, a1, a2, a3) =>
		(dynCall_viii = Module['dynCall_viii'] = wasmExports['nc'])(
			a0,
			a1,
			a2,
			a3
	...
	var dynCall_iiiiiii = (Module['dynCall_iiiiiii'] = (
		...
		(dynCall_iiiiiii = Module['dynCall_iiiiiii'] = wasmExports['sc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_iijii = (Module['dynCall_iijii'] = (a0, a1, a2, a3, a4) =>
		(dynCall_iijii = Module['dynCall_iijii'] = wasmExports['tc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_jii = (Module['dynCall_jii'] = (a0, a1, a2) =>
		(dynCall_jii = Module['dynCall_jii'] = wasmExports['uc'])(a0, a1, a2));

	var dynCall_jiii = (Module['dynCall_jiii'] = (a0, a1, a2, a3) =>
		(dynCall_jiii = Module['dynCall_jiii'] = wasmExports['vc'])(
			a0,
			a1,
			a2,
			a3
	...
	var dynCall_viiiiiiiii = (Module['dynCall_viiiiiiiii'] = (
		...
		(dynCall_viiiiiiiii = Module['dynCall_viiiiiiiii'] = wasmExports['wc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_viiiiiii = (Module['dynCall_viiiiiii'] = (
		...
		(dynCall_viiiiiii = Module['dynCall_viiiiiii'] = wasmExports['xc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_iiiiiiii = (Module['dynCall_iiiiiiii'] = (
		...
		(dynCall_iiiiiiii = Module['dynCall_iiiiiiii'] = wasmExports['yc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_iiiiiiiiii = (Module['dynCall_iiiiiiiiii'] = (
		...
		(dynCall_iiiiiiiiii = Module['dynCall_iiiiiiiiii'] = wasmExports['zc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_iiji = (Module['dynCall_iiji'] = (a0, a1, a2, a3) =>
		(dynCall_iiji = Module['dynCall_iiji'] = wasmExports['Ac'])(
			a0,
			a1,
			a2,
			a3
	...
	var dynCall_viijii = (Module['dynCall_viijii'] = (a0, a1, a2, a3, a4, a5) =>
		(dynCall_viijii = Module['dynCall_viijii'] = wasmExports['Bc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_iijiji = (Module['dynCall_iijiji'] = (a0, a1, a2, a3, a4, a5) =>
		(dynCall_iijiji = Module['dynCall_iijiji'] = wasmExports['Cc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_vji = (Module['dynCall_vji'] = (a0, a1, a2) =>
		(dynCall_vji = Module['dynCall_vji'] = wasmExports['Dc'])(a0, a1, a2));
