...
export const dependenciesTotalSize = 21819455;
...
/** not-t@type {!BigUint64Array} */ HEAPU64,
	...
	var _wasm_trace = (Module['_wasm_trace'] = (a0, a1) =>
		(_wasm_trace = Module['_wasm_trace'] = wasmExports['Cb'])(a0, a1));
	...
	var _wasm_add_cli_arg = (Module['_wasm_add_cli_arg'] = (a0) =>
		(_wasm_add_cli_arg = Module['_wasm_add_cli_arg'] = wasmExports['Eb'])(
			a0
		));

	var _run_cli = (Module['_run_cli'] = () =>
		(_run_cli = Module['_run_cli'] = wasmExports['Fb'])());
