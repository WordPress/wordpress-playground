...
export const dependenciesTotalSize = 11249043; 
...
function _js_open_process(command, args, argsLength, stdinFd, stdoutChildFd, stdoutParentFd, stderrChildFd, stderrParentFd) {
 if (!PHPWASM.proc_fds) {
  PHPWASM.proc_fds = {};
 }
 if (!command) {
