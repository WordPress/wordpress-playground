...
<<<<<<< HEAD
export const dependenciesTotalSize = 11967395; 
=======
export const dependenciesTotalSize = 21096546; 
>>>>>>> b6257b8e (Build PHP as emscripten MAIN_MODULE)
...
>>>>>>> b6257b8e (Build PHP as emscripten MAIN_MODULE)
  ...
  function ___call_sighandler(fp, sig) {
      (function(a1) {  Module['dynCall_vi'].apply(null, [fp, a1]); })(sig);
    }
  ...
  var ___stack_pointer = new WebAssembly.Global({'value': 'i32', 'mutable': true}, 7659184);
...
=======
  ...
  var PHPWASM = {getAllWebSockets:function(sock) {
  			...
  			return [promise, cancel];
  		},noop:function () { },shutdownSocket:function (socketd, how) {
  			const sock = getSocketFromFD(socketd);
  			const peer = Object.values(sock.peers)[0];
  ...
  var Asyncify = {State:{Normal:0,Unwinding:1,Rewinding:2,Disabled:3},state:0,StackSize:4096,currData:null,handleSleepReturnValue:0,exportCallStack:[],callStackNameToId:{},callStackIdToName:{},callStackId:0,asyncPromiseHandlers:null,sleepCallbacks:[],getCallStackId:function(funcName) {
        ...
        var rewindId = Asyncify.getCallStackId(bottomOfCallStack);
        HEAP32[(((ptr)+(8))>>2)] = rewindId;
      },getDataRewindFunc__deps:["$resolveGlobalSymbol"],getDataRewindFunc:function(ptr) {
        var id = HEAP32[(((ptr)+(8))>>2)];
        var name = Asyncify.callStackIdToName[id];
        var func = Module['asm'][name];
...
<<<<<<< HEAD
 return (_wasm_popen = Module["_wasm_popen"] = Module["asm"]["Xa"]).apply(null, arguments);
};

var ___errno_location = function() {
 return (___errno_location = Module["asm"]["Ya"]).apply(null, arguments);
=======
...
<<<<<<< HEAD
 return (_wasm_pclose = Module["_wasm_pclose"] = Module["asm"]["Za"]).apply(null, arguments);
=======
...
<<<<<<< HEAD
 return (_run_cli = Module["_run_cli"] = Module["asm"]["gb"]).apply(null, arguments);
=======
