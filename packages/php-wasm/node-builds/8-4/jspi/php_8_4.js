...
export const dependenciesTotalSize = 24740596;
...
/** not-@type {!BigUint64Array} */ HEAPU64;
	...
	var _core_globals = (Module['_core_globals'] = 15560416);

	var _php_ini_opened_path = (Module['_php_ini_opened_path'] = 15449296);

	var _php_ini_scanned_path = (Module['_php_ini_scanned_path'] = 15449300);

	var _php_ini_scanned_files = (Module['_php_ini_scanned_files'] = 15449304);

	var _sapi_module = (Module['_sapi_module'] = 15444472);

	var _sapi_globals = (Module['_sapi_globals'] = 15444616);

	var _module_registry = (Module['_module_registry'] = 15562376);

	var _zend_ce_closure = (Module['_zend_ce_closure'] = 15556028);

	var _compiler_globals = (Module['_compiler_globals'] = 15563928);

	var _executor_globals = (Module['_executor_globals'] = 15564344);

	var _zend_compile_file = (Module['_zend_compile_file'] = 15565736);

	var _zend_ce_exception = (Module['_zend_ce_exception'] = 15561500);

	var _zend_ce_error = (Module['_zend_ce_error'] = 15561616);

	var _zend_throw_exception_hook = (Module['_zend_throw_exception_hook'] =
		15561492);

	var _zend_ce_throwable = (Module['_zend_ce_throwable'] = 15561496);

	var _zend_execute_ex = (Module['_zend_execute_ex'] = 15562756);

	var _zend_execute_internal = (Module['_zend_execute_internal'] = 15562760);
	...
	var _zend_extensions = (Module['_zend_extensions'] = 15561244);

	var _gc_collect_cycles = (Module['_gc_collect_cycles'] = 15562752);

	var _zend_empty_array = (Module['_zend_empty_array'] = 14941216);

	var _zend_ce_aggregate = (Module['_zend_ce_aggregate'] = 15443840);

	var _zend_ce_iterator = (Module['_zend_ce_iterator'] = 15443844);

	var _zend_ce_countable = (Module['_zend_ce_countable'] = 15443856);

	var _std_object_handlers = (Module['_std_object_handlers'] = 14940704);

	var _zend_empty_string = (Module['_zend_empty_string'] = 15442352);

	var _zend_known_strings = (Module['_zend_known_strings'] = 15442356);

	var _zend_string_init_interned = (Module['_zend_string_init_interned'] =
		15442420);

	var _zend_one_char_string = (Module['_zend_one_char_string'] = 15442432);

	var _zend_write = (Module['_zend_write'] = 15563844);

	var _zend_error_cb = (Module['_zend_error_cb'] = 15563848);

	var _zend_post_startup_cb = (Module['_zend_post_startup_cb'] = 15563816);

	var ___memory_base = (Module['___memory_base'] = 0);

	var ___table_base = (Module['___table_base'] = 1);

	var _stderr = (Module['_stderr'] = 15435232);

	var _stdout = (Module['_stdout'] = 15435536);

	var _stdin = (Module['_stdin'] = 15435384);

	var _z_errmsg = (Module['_z_errmsg'] = 14942880);

	var _timezone = (Module['_timezone'] = 15901024);

	var _tzname = (Module['_tzname'] = 15901032);

	var ___heap_base = 16963296;
	...
	var __ZTVSt12length_error = (Module['__ZTVSt12length_error'] = 15436072);

	var __ZTISt12length_error = (Module['__ZTISt12length_error'] = 15436092);
