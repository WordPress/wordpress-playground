...
export const dependenciesTotalSize = 19071176;
...
/** not-@type {!BigUint64Array} */ HEAPU64;
	...
	var _core_globals = (Module['_core_globals'] = 12133920);

	var _php_ini_opened_path = (Module['_php_ini_opened_path'] = 11991328);

	var _php_ini_scanned_path = (Module['_php_ini_scanned_path'] = 11991332);

	var _php_ini_scanned_files = (Module['_php_ini_scanned_files'] = 11991336);

	var _sapi_module = (Module['_sapi_module'] = 12074764);

	var _sapi_globals = (Module['_sapi_globals'] = 12074912);

	var _compiler_globals = (Module['_compiler_globals'] = 12136672);

	var _executor_globals = (Module['_executor_globals'] = 12137048);

	var _zend_compile_file = (Module['_zend_compile_file'] = 12138208);

	var _zend_execute_ex = (Module['_zend_execute_ex'] = 12136560);

	var _zend_execute_internal = (Module['_zend_execute_internal'] = 12136564);

	var _zend_write = (Module['_zend_write'] = 12136600);

	var _zend_error_cb = (Module['_zend_error_cb'] = 12136608);

	var _zend_post_startup_cb = (Module['_zend_post_startup_cb'] = 12136580);

	var _module_registry = (Module['_module_registry'] = 12135448);

	var _zend_extensions = (Module['_zend_extensions'] = 12134776);

	var _zend_pass_function = (Module['_zend_pass_function'] = 11630620);

	var _zend_ce_aggregate = (Module['_zend_ce_aggregate'] = 11986888);

	var _zend_ce_iterator = (Module['_zend_ce_iterator'] = 11986892);

	var _zend_ce_countable = (Module['_zend_ce_countable'] = 11986904);

	var _zend_ce_exception = (Module['_zend_ce_exception'] = 12134968);

	var _zend_ce_error = (Module['_zend_ce_error'] = 12135084);

	var _zend_ce_throwable = (Module['_zend_ce_throwable'] = 12134952);

	var _zend_throw_exception_hook = (Module['_zend_throw_exception_hook'] =
		12134964);

	var _gc_collect_cycles = (Module['_gc_collect_cycles'] = 11986452);

	var _zend_ce_closure = (Module['_zend_ce_closure'] = 12131640);

	var _zend_empty_string = (Module['_zend_empty_string'] = 11985312);

	var _zend_known_strings = (Module['_zend_known_strings'] = 11985316);
	...
	var ___THREW__ = (Module['___THREW__'] = 12186180);

	var ___threwValue = (Module['___threwValue'] = 12186184);

	var _stdout = (Module['_stdout'] = 11978384);

	var _timezone = (Module['_timezone'] = 12173072);

	var _tzname = (Module['_tzname'] = 12173080);

	var ___heap_base = 13234864;
