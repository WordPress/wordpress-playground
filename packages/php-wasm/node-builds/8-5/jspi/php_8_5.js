...
/** not-@type {!BigUint64Array} */ HEAPU64;
	...
	var _file_globals = (Module['_file_globals'] = 18177216);

	var _core_globals = (Module['_core_globals'] = 18176728);

	var _php_ini_opened_path = (Module['_php_ini_opened_path'] = 18064576);

	var _php_ini_scanned_path = (Module['_php_ini_scanned_path'] = 18064580);

	var _php_ini_scanned_files = (Module['_php_ini_scanned_files'] = 18064584);

	var _sapi_module = (Module['_sapi_module'] = 18059744);

	var _sapi_globals = (Module['_sapi_globals'] = 18059896);

	var _module_registry = (Module['_module_registry'] = 18179664);

	var _zend_ce_closure = (Module['_zend_ce_closure'] = 18177596);

	var _compiler_globals = (Module['_compiler_globals'] = 18181288);

	var _executor_globals = (Module['_executor_globals'] = 18181704);

	var _zend_compile_file = (Module['_zend_compile_file'] = 18183120);

	var _zend_compile_string = (Module['_zend_compile_string'] = 18183124);

	var _zend_ce_unit_enum = (Module['_zend_ce_unit_enum'] = 18059440);

	var _zend_ce_backed_enum = (Module['_zend_ce_backed_enum'] = 18059444);

	var _zend_ce_exception = (Module['_zend_ce_exception'] = 18177724);

	var _zend_ce_error = (Module['_zend_ce_error'] = 18177848);

	var _zend_throw_exception_hook = (Module['_zend_throw_exception_hook'] =
		18177720);

	var _zend_ce_throwable = (Module['_zend_ce_throwable'] = 18177728);
	...
	var _zend_execute_ex = (Module['_zend_execute_ex'] = 18179648);

	var _zend_execute_internal = (Module['_zend_execute_internal'] = 18179652);

	var _zend_pass_function = (Module['_zend_pass_function'] = 17541056);

	var _zend_extensions = (Module['_zend_extensions'] = 18177564);

	var _gc_collect_cycles = (Module['_gc_collect_cycles'] = 18180048);

	var _zend_empty_array = (Module['_zend_empty_array'] = 17556368);

	var _zend_ce_traversable = (Module['_zend_ce_traversable'] = 18059100);

	var _zend_ce_aggregate = (Module['_zend_ce_aggregate'] = 18059104);

	var _zend_ce_iterator = (Module['_zend_ce_iterator'] = 18059108);

	var _zend_ce_serializable = (Module['_zend_ce_serializable'] = 18059112);

	var _zend_ce_arrayaccess = (Module['_zend_ce_arrayaccess'] = 18059116);

	var _zend_ce_countable = (Module['_zend_ce_countable'] = 18059120);

	var _zend_ce_stringable = (Module['_zend_ce_stringable'] = 18059124);

	var _std_object_handlers = (Module['_std_object_handlers'] = 17539760);

	var _zend_empty_string = (Module['_zend_empty_string'] = 18180052);

	var _zend_known_strings = (Module['_zend_known_strings'] = 18180056);

	var _zend_string_init_interned = (Module['_zend_string_init_interned'] =
		18180124);

	var _zend_one_char_string = (Module['_zend_one_char_string'] = 18180144);

	var _zend_write = (Module['_zend_write'] = 18181204);

	var _zend_error_cb = (Module['_zend_error_cb'] = 18181208);

	var _zend_post_startup_cb = (Module['_zend_post_startup_cb'] = 18181176);
	...
	var _timezone = (Module['_timezone'] = 18518400);

	var _tzname = (Module['_tzname'] = 18518408);

	var ___heap_base = 19580672;
