...
export const dependenciesTotalSize = 26060784;
...
/** not-@type {!BigUint64Array} */ HEAPU64;
	...
	var _file_globals = (Module['_file_globals'] = 18177312);

	var _core_globals = (Module['_core_globals'] = 18176824);

	var _php_ini_opened_path = (Module['_php_ini_opened_path'] = 18064672);

	var _php_ini_scanned_path = (Module['_php_ini_scanned_path'] = 18064676);

	var _php_ini_scanned_files = (Module['_php_ini_scanned_files'] = 18064680);

	var _sapi_module = (Module['_sapi_module'] = 18059840);

	var _sapi_globals = (Module['_sapi_globals'] = 18059992);

	var _module_registry = (Module['_module_registry'] = 18179760);

	var _zend_ce_closure = (Module['_zend_ce_closure'] = 18177692);

	var _compiler_globals = (Module['_compiler_globals'] = 18181384);

	var _executor_globals = (Module['_executor_globals'] = 18181800);

	var _zend_compile_file = (Module['_zend_compile_file'] = 18183216);

	var _zend_compile_string = (Module['_zend_compile_string'] = 18183220);

	var _zend_ce_unit_enum = (Module['_zend_ce_unit_enum'] = 18059536);

	var _zend_ce_backed_enum = (Module['_zend_ce_backed_enum'] = 18059540);

	var _zend_ce_exception = (Module['_zend_ce_exception'] = 18177820);

	var _zend_ce_error = (Module['_zend_ce_error'] = 18177944);

	var _zend_throw_exception_hook = (Module['_zend_throw_exception_hook'] =
		18177816);

	var _zend_ce_throwable = (Module['_zend_ce_throwable'] = 18177824);
	...
	var _zend_execute_ex = (Module['_zend_execute_ex'] = 18179744);

	var _zend_execute_internal = (Module['_zend_execute_internal'] = 18179748);

	var _zend_pass_function = (Module['_zend_pass_function'] = 17541040);

	var _zend_extensions = (Module['_zend_extensions'] = 18177660);

	var _gc_collect_cycles = (Module['_gc_collect_cycles'] = 18180144);

	var _zend_empty_array = (Module['_zend_empty_array'] = 17556352);

	var _zend_ce_traversable = (Module['_zend_ce_traversable'] = 18059196);

	var _zend_ce_aggregate = (Module['_zend_ce_aggregate'] = 18059200);

	var _zend_ce_iterator = (Module['_zend_ce_iterator'] = 18059204);

	var _zend_ce_serializable = (Module['_zend_ce_serializable'] = 18059208);

	var _zend_ce_arrayaccess = (Module['_zend_ce_arrayaccess'] = 18059212);

	var _zend_ce_countable = (Module['_zend_ce_countable'] = 18059216);

	var _zend_ce_stringable = (Module['_zend_ce_stringable'] = 18059220);

	var _std_object_handlers = (Module['_std_object_handlers'] = 17539744);

	var _zend_empty_string = (Module['_zend_empty_string'] = 18180148);

	var _zend_known_strings = (Module['_zend_known_strings'] = 18180152);

	var _zend_string_init_interned = (Module['_zend_string_init_interned'] =
		18180220);

	var _zend_one_char_string = (Module['_zend_one_char_string'] = 18180240);

	var _zend_write = (Module['_zend_write'] = 18181300);

	var _zend_error_cb = (Module['_zend_error_cb'] = 18181304);

	var _zend_post_startup_cb = (Module['_zend_post_startup_cb'] = 18181272);
	...
	var _timezone = (Module['_timezone'] = 18518496);

	var _tzname = (Module['_tzname'] = 18518504);

	var ___heap_base = 19580768;
