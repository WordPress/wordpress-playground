...
PHP 7.3 WebAssembly binaries for Node.js.

This package contains:

- JSPI and Asyncify variants of PHP 7.3 compiled to WebAssembly
- intl extension for PHP 7.3
- xdebug extension for PHP 7.3

## Installation

```bash
npm install @php-wasm/node-7-3
```

## Usage

```typescript
import { getPHPLoaderModule, getIntlExtensionPath } from '@php-wasm/node-7-3';
