...
export const dependenciesTotalSize = 22422047;
...
/** not-@type {!BigUint64Array} */ HEAPU64;
	...
	var _file_globals = (Module['_file_globals'] = 12906032);

	var _core_globals = (Module['_core_globals'] = 12905536);

	var _php_ini_opened_path = (Module['_php_ini_opened_path'] = 12765664);

	var _php_ini_scanned_path = (Module['_php_ini_scanned_path'] = 12765668);

	var _php_ini_scanned_files = (Module['_php_ini_scanned_files'] = 12765672);

	var _sapi_module = (Module['_sapi_module'] = 12846824);

	var _sapi_globals = (Module['_sapi_globals'] = 12846968);

	var _compiler_globals = (Module['_compiler_globals'] = 12908864);

	var _executor_globals = (Module['_executor_globals'] = 12909248);

	var _zend_compile_file = (Module['_zend_compile_file'] = 12910456);

	var _zend_compile_string = (Module['_zend_compile_string'] = 12910460);

	var _zend_execute_ex = (Module['_zend_execute_ex'] = 12908672);

	var _zend_execute_internal = (Module['_zend_execute_internal'] = 12908676);

	var _empty_fcall_info = (Module['_empty_fcall_info'] = 9388216);

	var _empty_fcall_info_cache = (Module['_empty_fcall_info_cache'] = 9388264);

	var _zend_write = (Module['_zend_write'] = 12908788);

	var _zend_error_cb = (Module['_zend_error_cb'] = 12908792);

	var _zend_post_startup_cb = (Module['_zend_post_startup_cb'] = 12908772);

	var _module_registry = (Module['_module_registry'] = 12908688);

	var _zend_extensions = (Module['_zend_extensions'] = 12906376);

	var _zend_empty_array = (Module['_zend_empty_array'] = 12258144);

	var _zend_pass_function = (Module['_zend_pass_function'] = 12243328);

	var _zend_ce_traversable = (Module['_zend_ce_traversable'] = 12760836);

	var _zend_ce_aggregate = (Module['_zend_ce_aggregate'] = 12760840);

	var _zend_ce_iterator = (Module['_zend_ce_iterator'] = 12760844);

	var _zend_ce_serializable = (Module['_zend_ce_serializable'] = 12760848);

	var _zend_ce_arrayaccess = (Module['_zend_ce_arrayaccess'] = 12760852);

	var _zend_ce_countable = (Module['_zend_ce_countable'] = 12760856);

	var _zend_ce_stringable = (Module['_zend_ce_stringable'] = 12760860);

	var _zend_ce_exception = (Module['_zend_ce_exception'] = 12906632);

	var _zend_ce_error = (Module['_zend_ce_error'] = 12906748);

	var _zend_ce_throwable = (Module['_zend_ce_throwable'] = 12906616);
	...
	var _gc_collect_cycles = (Module['_gc_collect_cycles'] = 12907628);

	var _zend_ce_closure = (Module['_zend_ce_closure'] = 12867292);

	var _zend_empty_string = (Module['_zend_empty_string'] = 12759312);

	var _zend_known_strings = (Module['_zend_known_strings'] = 12759316);

	var _zend_string_init_interned = (Module['_zend_string_init_interned'] =
		12759380);

	var _zend_one_char_string = (Module['_zend_one_char_string'] = 12759392);

	var _std_object_handlers = (Module['_std_object_handlers'] = 11839584);

	var _zend_ce_unit_enum = (Module['_zend_ce_unit_enum'] = 12761064);

	var _zend_ce_backed_enum = (Module['_zend_ce_backed_enum'] = 12761068);
	...
	var _timezone = (Module['_timezone'] = 13245744);

	var _tzname = (Module['_tzname'] = 13245752);

	var ___heap_base = 14308016;
