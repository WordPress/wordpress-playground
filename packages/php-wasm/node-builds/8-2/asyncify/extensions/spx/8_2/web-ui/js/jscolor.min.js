		...
		var e = {
			...
			detachGroupEvents: function (t) {
				if (e._attachedGroupEvents.hasOwnProperty(t)) {
					for (
						var n = 0;
						n < e._attachedGroupEvents[t].length;
						n += 1
					) {
			...
			releaseTarget: function () {
				e._capturedTarget &&
					(e._capturedTarget.releaseCapture(),
			...
			redrawPosition: function () {
				if (e.picker && e.picker.owner) {
					var t = e.picker.owner,
						...
						r;
					t.fixed
						? ((n = e.getElementPos(t.targetElement, !0)),
							(r = [0, 0]))
						: ((n = e.getElementPos(t.targetElement)),
							(r = e.getViewPos()));
				...
				var n = !!e.getSliderComponent(t),
					r = [
						...
						2 * t.insetWidth +
							...
							t.height +
							(t.closable
								? 2 * t.insetWidth + t.padding + t.buttonHeight
								: 0),
					];
				return r;
			},
			...
			onDocumentMouseDown: function (t) {
				...
				n._jscLinkedInstance
					? n._jscLinkedInstance.showOnClick &&
						n._jscLinkedInstance.show()
					: n._jscControlName
						? e.onControlPointerStart(
								t,
								n,
								n._jscControlName,
								'mouse'
			...
			jscolor: function (t, n) {
				...
				function u() {
					...
					var t = e.picker,
						...
						r = e.getPickerDims(d),
						i =
							2 * d.pointerBorderWidth +
							d.pointerThickness +
							2 * d.crossSize,
						s = e.getPadToSliderPadding(d),
						o = Math.min(
							d.borderRadius,
							Math.round(d.padding * Math.PI)
						),
						u = 'crosshair';
					((t.wrap.style.clear = 'both'),
						...
						(t.padM.style.background = t.sldM.style.background =
							'#FFF'),
						...
						(t.crossBY.style.position = t.crossBX.style.position =
							'absolute'),
						(t.crossBY.style.background =
						...
						(t.crossBY.style.width = t.crossBX.style.height =
							...
							d.pointerThickness +
							'px'),
						(t.crossBY.style.height = t.crossBX.style.width =
							i + 'px'),
						...
						(t.crossLY.style.position = t.crossLX.style.position =
							'absolute'),
						(t.crossLY.style.background =
					...
					((t.btn.onmousedown = function () {
						...
						(t.btnT.innerHTML = ''),
						t.btnT.appendChild(
							document.createTextNode(d.closeText)
						),
						a(),
						f(),
						e.picker.owner &&
				...
				((this.hide = function () {
					...
					(this.fromRGB = function (e, t, n, r) {
						...
						(o[0] !== null &&
							(this.hsv[0] = Math.max(0, Math.min(360, o[0]))),
							o[2] !== 0 &&
								(this.hsv[1] =
									o[1] === null
										? null
						...
						if (
							...
							return (
								n[1].length === 6
									...
									: this.fromRGB(
											parseInt(
												n[1].charAt(0) + n[1].charAt(0),
												16
											),
											parseInt(
												n[1].charAt(1) + n[1].charAt(1),
												16
											),
											parseInt(
												n[1].charAt(2) + n[1].charAt(2),
												16
											),
											t
										),
					...
					(this.toString = function () {
						return (
							(256 | Math.round(this.rgb[0]))
								.toString(16)
								.substr(1) +
							(256 | Math.round(this.rgb[1]))
								.toString(16)
								.substr(1) +
							(256 | Math.round(this.rgb[2]))
								.toString(16)
								.substr(1)
						);
					}),
