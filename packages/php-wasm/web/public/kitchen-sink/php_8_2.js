...
export const dependenciesTotalSize = 10597364; 
...
function _js_open_process(command, stdinFd, stdoutChildFd, stdoutParentFd, stderrChildFd, stderrParentFd) {
 ...
 return Asyncify.handleSleep((async wakeUp => {
  ...
  cp.stdout.on("data", (function(data) {
   ...
   }, stdoutAt, stdoutStream.shared.position, stdoutStream.node.usedBytes);
   ProcInfo.stdout.emit("data", data);
...
var _wasm_read = Module["_wasm_read"] = function() {
 return (_wasm_read = Module["_wasm_read"] = Module["asm"]["pb"]).apply(null, arguments);
};
