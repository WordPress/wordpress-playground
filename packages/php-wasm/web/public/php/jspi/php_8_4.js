...
export const dependenciesTotalSize = 34443858; 
...
url = SOCKFS.websocketArgs["url"](...arguments);
  ...
  instrumentWasmExports(exports) {
        var exportPattern = /^(php_wasm_init|fd_close|wasm_sleep|wasm_read|emscripten_sleep|wasm_sapi_handle_request|wasm_sapi_request_shutdown|wasm_poll_socket|wrap_select|__wrap_select|select|php_pollfd_for|fflush|wasm_popen|wasm_read|wasm_php_exec|run_cli|wasm_recv|main|__main_argc_argv)$/;
