var dependencyFilename = "bc7d2a15ea4d5d40.wasm";

const dependenciesTotalSize = 10237984; function php8_2_node(RuntimeName, PHPLoader, EnvVariables) {
...
Module["_wasm_popen"] = function() {
 return (Module["_wasm_popen"] = Module["asm"]["bb"]).apply(null, arguments);
};
...
Module["_wasm_pclose"] = function() {
 return (Module["_wasm_pclose"] = Module["asm"]["db"]).apply(null, arguments);
};

Module["_php_pollfd_for"] = function() {
 return (Module["_php_pollfd_for"] = Module["asm"]["eb"]).apply(null, arguments);
};

Module["_wasm_select"] = function() {
 return (Module["_wasm_select"] = Module["asm"]["fb"]).apply(null, arguments);
};

Module["_wasm_add_cli_arg"] = function() {
 return (Module["_wasm_add_cli_arg"] = Module["asm"]["gb"]).apply(null, arguments);
};
...
Module["_run_cli"] = function() {
 return (Module["_run_cli"] = Module["asm"]["ib"]).apply(null, arguments);
};

var _memcpy = Module["_memcpy"] = function() {
 return (_memcpy = Module["_memcpy"] = Module["asm"]["jb"]).apply(null, arguments);
};
...
var _fflush = Module["_fflush"] = function() {
 return (_fflush = Module["_fflush"] = Module["asm"]["mb"]).apply(null, arguments);
};

var _htons = Module["_htons"] = function() {
 return (_htons = Module["_htons"] = Module["asm"]["nb"]).apply(null, arguments);
};

var _ntohs = Module["_ntohs"] = function() {
 return (_ntohs = Module["_ntohs"] = Module["asm"]["ob"]).apply(null, arguments);
};

var _htonl = Module["_htonl"] = function() {
 return (_htonl = Module["_htonl"] = Module["asm"]["pb"]).apply(null, arguments);
};

Module["_wasm_set_phpini_path"] = function() {
 return (Module["_wasm_set_phpini_path"] = Module["asm"]["qb"]).apply(null, arguments);
};

Module["_wasm_set_phpini_entries"] = function() {
 return (Module["_wasm_set_phpini_entries"] = Module["asm"]["rb"]).apply(null, arguments);
};

Module["_wasm_add_SERVER_entry"] = function() {
 return (Module["_wasm_add_SERVER_entry"] = Module["asm"]["sb"]).apply(null, arguments);
};

Module["_wasm_add_uploaded_file"] = function() {
 return (Module["_wasm_add_uploaded_file"] = Module["asm"]["tb"]).apply(null, arguments);
};

Module["_wasm_set_query_string"] = function() {
 return (Module["_wasm_set_query_string"] = Module["asm"]["ub"]).apply(null, arguments);
};

Module["_wasm_set_path_translated"] = function() {
 return (Module["_wasm_set_path_translated"] = Module["asm"]["vb"]).apply(null, arguments);
};

Module["_wasm_set_skip_shebang"] = function() {
 return (Module["_wasm_set_skip_shebang"] = Module["asm"]["wb"]).apply(null, arguments);
};

Module["_wasm_set_request_uri"] = function() {
 return (Module["_wasm_set_request_uri"] = Module["asm"]["xb"]).apply(null, arguments);
};

Module["_wasm_set_request_method"] = function() {
 return (Module["_wasm_set_request_method"] = Module["asm"]["yb"]).apply(null, arguments);
};

Module["_wasm_set_request_host"] = function() {
 return (Module["_wasm_set_request_host"] = Module["asm"]["zb"]).apply(null, arguments);
};

Module["_wasm_set_content_type"] = function() {
 return (Module["_wasm_set_content_type"] = Module["asm"]["Ab"]).apply(null, arguments);
};

Module["_wasm_set_request_body"] = function() {
 return (Module["_wasm_set_request_body"] = Module["asm"]["Bb"]).apply(null, arguments);
};

Module["_wasm_set_content_length"] = function() {
 return (Module["_wasm_set_content_length"] = Module["asm"]["Cb"]).apply(null, arguments);
};

Module["_wasm_set_cookies"] = function() {
 return (Module["_wasm_set_cookies"] = Module["asm"]["Db"]).apply(null, arguments);
};

Module["_wasm_set_php_code"] = function() {
 return (Module["_wasm_set_php_code"] = Module["asm"]["Eb"]).apply(null, arguments);
};

Module["_wasm_set_request_port"] = function() {
 return (Module["_wasm_set_request_port"] = Module["asm"]["Fb"]).apply(null, arguments);
};

Module["_phpwasm_init_uploaded_files_hash"] = function() {
 return (Module["_phpwasm_init_uploaded_files_hash"] = Module["asm"]["Gb"]).apply(null, arguments);
};

Module["_phpwasm_register_uploaded_file"] = function() {
 return (Module["_phpwasm_register_uploaded_file"] = Module["asm"]["Hb"]).apply(null, arguments);
};

Module["_phpwasm_destroy_uploaded_files_hash"] = function() {
 return (Module["_phpwasm_destroy_uploaded_files_hash"] = Module["asm"]["Ib"]).apply(null, arguments);
};

Module["_wasm_sapi_handle_request"] = function() {
 return (Module["_wasm_sapi_handle_request"] = Module["asm"]["Jb"]).apply(null, arguments);
};

Module["_php_wasm_init"] = function() {
 return (Module["_php_wasm_init"] = Module["asm"]["Kb"]).apply(null, arguments);
};

var ___funcs_on_exit = Module["___funcs_on_exit"] = function() {
 return (___funcs_on_exit = Module["___funcs_on_exit"] = Module["asm"]["Lb"]).apply(null, arguments);
};
...
var _asyncify_start_unwind = Module["_asyncify_start_unwind"] = function() {
 return (_asyncify_start_unwind = Module["_asyncify_start_unwind"] = Module["asm"]["ic"]).apply(null, arguments);
};

var _asyncify_stop_unwind = Module["_asyncify_stop_unwind"] = function() {
 return (_asyncify_stop_unwind = Module["_asyncify_stop_unwind"] = Module["asm"]["jc"]).apply(null, arguments);
};

var _asyncify_start_rewind = Module["_asyncify_start_rewind"] = function() {
 return (_asyncify_start_rewind = Module["_asyncify_start_rewind"] = Module["asm"]["kc"]).apply(null, arguments);
};

var _asyncify_stop_rewind = Module["_asyncify_stop_rewind"] = function() {
 return (_asyncify_stop_rewind = Module["_asyncify_stop_rewind"] = Module["asm"]["lc"]).apply(null, arguments);
};
...
export { php8_2_node as default, dependenciesTotalSize, dependencyFilename };
