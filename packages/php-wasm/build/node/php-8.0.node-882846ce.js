var dependencyFilename = "4480346f9f8b7d84.wasm";

const dependenciesTotalSize = 10111458; function php8_0_node(RuntimeName, PHPLoader, EnvVariables) {
...
Module["___wasm_call_ctors"] = function() {
 return (Module["___wasm_call_ctors"] = Module["asm"]["Ya"]).apply(null, arguments);
};

Module["_wasm_popen"] = function() {
 return (Module["_wasm_popen"] = Module["asm"]["Za"]).apply(null, arguments);
};
...
Module["_wasm_pclose"] = function() {
 return (Module["_wasm_pclose"] = Module["asm"]["$a"]).apply(null, arguments);
};

Module["_php_pollfd_for"] = function() {
 return (Module["_php_pollfd_for"] = Module["asm"]["ab"]).apply(null, arguments);
};

Module["_wasm_select"] = function() {
 return (Module["_wasm_select"] = Module["asm"]["bb"]).apply(null, arguments);
};

Module["_wasm_add_cli_arg"] = function() {
 return (Module["_wasm_add_cli_arg"] = Module["asm"]["cb"]).apply(null, arguments);
};
...
Module["_run_cli"] = function() {
 return (Module["_run_cli"] = Module["asm"]["eb"]).apply(null, arguments);
};
...
Module["_wasm_set_phpini_path"] = function() {
 return (Module["_wasm_set_phpini_path"] = Module["asm"]["mb"]).apply(null, arguments);
};

Module["_wasm_set_phpini_entries"] = function() {
 return (Module["_wasm_set_phpini_entries"] = Module["asm"]["nb"]).apply(null, arguments);
};

Module["_wasm_add_SERVER_entry"] = function() {
 return (Module["_wasm_add_SERVER_entry"] = Module["asm"]["ob"]).apply(null, arguments);
};

Module["_wasm_add_uploaded_file"] = function() {
 return (Module["_wasm_add_uploaded_file"] = Module["asm"]["pb"]).apply(null, arguments);
};

Module["_wasm_set_query_string"] = function() {
 return (Module["_wasm_set_query_string"] = Module["asm"]["qb"]).apply(null, arguments);
};

Module["_wasm_set_path_translated"] = function() {
 return (Module["_wasm_set_path_translated"] = Module["asm"]["rb"]).apply(null, arguments);
};

Module["_wasm_set_skip_shebang"] = function() {
 return (Module["_wasm_set_skip_shebang"] = Module["asm"]["sb"]).apply(null, arguments);
};

Module["_wasm_set_request_uri"] = function() {
 return (Module["_wasm_set_request_uri"] = Module["asm"]["tb"]).apply(null, arguments);
};

Module["_wasm_set_request_method"] = function() {
 return (Module["_wasm_set_request_method"] = Module["asm"]["ub"]).apply(null, arguments);
};

Module["_wasm_set_request_host"] = function() {
 return (Module["_wasm_set_request_host"] = Module["asm"]["vb"]).apply(null, arguments);
};

Module["_wasm_set_content_type"] = function() {
 return (Module["_wasm_set_content_type"] = Module["asm"]["wb"]).apply(null, arguments);
};

Module["_wasm_set_request_body"] = function() {
 return (Module["_wasm_set_request_body"] = Module["asm"]["xb"]).apply(null, arguments);
};

Module["_wasm_set_content_length"] = function() {
 return (Module["_wasm_set_content_length"] = Module["asm"]["yb"]).apply(null, arguments);
};

Module["_wasm_set_cookies"] = function() {
 return (Module["_wasm_set_cookies"] = Module["asm"]["zb"]).apply(null, arguments);
};

Module["_wasm_set_php_code"] = function() {
 return (Module["_wasm_set_php_code"] = Module["asm"]["Ab"]).apply(null, arguments);
};

Module["_wasm_set_request_port"] = function() {
 return (Module["_wasm_set_request_port"] = Module["asm"]["Bb"]).apply(null, arguments);
};

Module["_phpwasm_init_uploaded_files_hash"] = function() {
 return (Module["_phpwasm_init_uploaded_files_hash"] = Module["asm"]["Cb"]).apply(null, arguments);
};

Module["_phpwasm_register_uploaded_file"] = function() {
 return (Module["_phpwasm_register_uploaded_file"] = Module["asm"]["Db"]).apply(null, arguments);
};

Module["_phpwasm_destroy_uploaded_files_hash"] = function() {
 return (Module["_phpwasm_destroy_uploaded_files_hash"] = Module["asm"]["Eb"]).apply(null, arguments);
};

Module["_wasm_sapi_handle_request"] = function() {
 return (Module["_wasm_sapi_handle_request"] = Module["asm"]["Fb"]).apply(null, arguments);
};

Module["_php_wasm_init"] = function() {
 return (Module["_php_wasm_init"] = Module["asm"]["Gb"]).apply(null, arguments);
};
...
export { php8_0_node as default, dependenciesTotalSize, dependencyFilename };
