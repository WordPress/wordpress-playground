var dependencyFilename = "bd3ec9aadc61c132.wasm";

const dependenciesTotalSize = 10912357; function php7_4_node(RuntimeName, PHPLoader, EnvVariables) {
...
Module["___wasm_call_ctors"] = function() {
 return (Module["___wasm_call_ctors"] = Module["asm"]["Xa"]).apply(null, arguments);
};

Module["_wasm_popen"] = function() {
 return (Module["_wasm_popen"] = Module["asm"]["Ya"]).apply(null, arguments);
};

var ___errno_location = Module["___errno_location"] = function() {
 return (___errno_location = Module["___errno_location"] = Module["asm"]["Za"]).apply(null, arguments);
};

Module["_wasm_pclose"] = function() {
 return (Module["_wasm_pclose"] = Module["asm"]["_a"]).apply(null, arguments);
};

Module["_php_pollfd_for"] = function() {
 return (Module["_php_pollfd_for"] = Module["asm"]["$a"]).apply(null, arguments);
};

Module["_wasm_select"] = function() {
 return (Module["_wasm_select"] = Module["asm"]["ab"]).apply(null, arguments);
};

Module["_wasm_add_cli_arg"] = function() {
 return (Module["_wasm_add_cli_arg"] = Module["asm"]["bb"]).apply(null, arguments);
};
...
Module["_run_cli"] = function() {
 return (Module["_run_cli"] = Module["asm"]["db"]).apply(null, arguments);
};

var _memcpy = Module["_memcpy"] = function() {
 return (_memcpy = Module["_memcpy"] = Module["asm"]["eb"]).apply(null, arguments);
};
...
var _htons = Module["_htons"] = function() {
 return (_htons = Module["_htons"] = Module["asm"]["ib"]).apply(null, arguments);
};

var _ntohs = Module["_ntohs"] = function() {
 return (_ntohs = Module["_ntohs"] = Module["asm"]["jb"]).apply(null, arguments);
};

var _htonl = Module["_htonl"] = function() {
 return (_htonl = Module["_htonl"] = Module["asm"]["kb"]).apply(null, arguments);
};

Module["_wasm_set_phpini_path"] = function() {
 return (Module["_wasm_set_phpini_path"] = Module["asm"]["lb"]).apply(null, arguments);
};

Module["_wasm_set_phpini_entries"] = function() {
 return (Module["_wasm_set_phpini_entries"] = Module["asm"]["mb"]).apply(null, arguments);
};

Module["_wasm_add_SERVER_entry"] = function() {
 return (Module["_wasm_add_SERVER_entry"] = Module["asm"]["nb"]).apply(null, arguments);
};

Module["_wasm_add_uploaded_file"] = function() {
 return (Module["_wasm_add_uploaded_file"] = Module["asm"]["ob"]).apply(null, arguments);
};

Module["_wasm_set_query_string"] = function() {
 return (Module["_wasm_set_query_string"] = Module["asm"]["pb"]).apply(null, arguments);
};

Module["_wasm_set_path_translated"] = function() {
 return (Module["_wasm_set_path_translated"] = Module["asm"]["qb"]).apply(null, arguments);
};

Module["_wasm_set_skip_shebang"] = function() {
 return (Module["_wasm_set_skip_shebang"] = Module["asm"]["rb"]).apply(null, arguments);
};

Module["_wasm_set_request_uri"] = function() {
 return (Module["_wasm_set_request_uri"] = Module["asm"]["sb"]).apply(null, arguments);
};

Module["_wasm_set_request_method"] = function() {
 return (Module["_wasm_set_request_method"] = Module["asm"]["tb"]).apply(null, arguments);
};

Module["_wasm_set_request_host"] = function() {
 return (Module["_wasm_set_request_host"] = Module["asm"]["ub"]).apply(null, arguments);
};

Module["_wasm_set_content_type"] = function() {
 return (Module["_wasm_set_content_type"] = Module["asm"]["vb"]).apply(null, arguments);
};

Module["_wasm_set_request_body"] = function() {
 return (Module["_wasm_set_request_body"] = Module["asm"]["wb"]).apply(null, arguments);
};

Module["_wasm_set_content_length"] = function() {
 return (Module["_wasm_set_content_length"] = Module["asm"]["xb"]).apply(null, arguments);
};

Module["_wasm_set_cookies"] = function() {
 return (Module["_wasm_set_cookies"] = Module["asm"]["yb"]).apply(null, arguments);
};

Module["_wasm_set_php_code"] = function() {
 return (Module["_wasm_set_php_code"] = Module["asm"]["zb"]).apply(null, arguments);
};

Module["_wasm_set_request_port"] = function() {
 return (Module["_wasm_set_request_port"] = Module["asm"]["Ab"]).apply(null, arguments);
};

Module["_phpwasm_init_uploaded_files_hash"] = function() {
 return (Module["_phpwasm_init_uploaded_files_hash"] = Module["asm"]["Bb"]).apply(null, arguments);
};

Module["_phpwasm_register_uploaded_file"] = function() {
 return (Module["_phpwasm_register_uploaded_file"] = Module["asm"]["Cb"]).apply(null, arguments);
};

Module["_phpwasm_destroy_uploaded_files_hash"] = function() {
 return (Module["_phpwasm_destroy_uploaded_files_hash"] = Module["asm"]["Db"]).apply(null, arguments);
};

Module["_wasm_sapi_handle_request"] = function() {
 return (Module["_wasm_sapi_handle_request"] = Module["asm"]["Eb"]).apply(null, arguments);
};

Module["_php_wasm_init"] = function() {
 return (Module["_php_wasm_init"] = Module["asm"]["Fb"]).apply(null, arguments);
};

var ___funcs_on_exit = Module["___funcs_on_exit"] = function() {
 return (___funcs_on_exit = Module["___funcs_on_exit"] = Module["asm"]["Gb"]).apply(null, arguments);
};

var _emscripten_builtin_memalign = Module["_emscripten_builtin_memalign"] = function() {
 return (_emscripten_builtin_memalign = Module["_emscripten_builtin_memalign"] = Module["asm"]["Hb"]).apply(null, arguments);
};
...
var dynCall_iiiii = Module["dynCall_iiiii"] = function() {
 return (dynCall_iiiii = Module["dynCall_iiiii"] = Module["asm"]["Qb"]).apply(null, arguments);
};
...
var dynCall_i = Module["dynCall_i"] = function() {
 return (dynCall_i = Module["dynCall_i"] = Module["asm"]["Wb"]).apply(null, arguments);
};

var dynCall_v = Module["dynCall_v"] = function() {
 return (dynCall_v = Module["dynCall_v"] = Module["asm"]["Xb"]).apply(null, arguments);
};
...
export { php7_4_node as default, dependenciesTotalSize, dependencyFilename };
