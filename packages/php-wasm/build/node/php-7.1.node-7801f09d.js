var dependencyFilename = "3ffea6407dea564f.wasm";

const dependenciesTotalSize = 10318118; function php7_1_node(RuntimeName, PHPLoader, EnvVariables) {
...
Module["___wasm_call_ctors"] = function() {
 return (Module["___wasm_call_ctors"] = Module["asm"]["Ta"]).apply(null, arguments);
};

Module["_wasm_popen"] = function() {
 return (Module["_wasm_popen"] = Module["asm"]["Ua"]).apply(null, arguments);
};
...
Module["_wasm_pclose"] = function() {
 return (Module["_wasm_pclose"] = Module["asm"]["Wa"]).apply(null, arguments);
};

Module["_php_pollfd_for"] = function() {
 return (Module["_php_pollfd_for"] = Module["asm"]["Xa"]).apply(null, arguments);
};

Module["_wasm_select"] = function() {
 return (Module["_wasm_select"] = Module["asm"]["Ya"]).apply(null, arguments);
};

Module["_wasm_add_cli_arg"] = function() {
 return (Module["_wasm_add_cli_arg"] = Module["asm"]["Za"]).apply(null, arguments);
};
...
Module["_run_cli"] = function() {
 return (Module["_run_cli"] = Module["asm"]["$a"]).apply(null, arguments);
};
...
Module["_wasm_set_phpini_path"] = function() {
 return (Module["_wasm_set_phpini_path"] = Module["asm"]["gb"]).apply(null, arguments);
};

Module["_wasm_set_phpini_entries"] = function() {
 return (Module["_wasm_set_phpini_entries"] = Module["asm"]["hb"]).apply(null, arguments);
};

Module["_wasm_add_SERVER_entry"] = function() {
 return (Module["_wasm_add_SERVER_entry"] = Module["asm"]["ib"]).apply(null, arguments);
};

Module["_wasm_add_uploaded_file"] = function() {
 return (Module["_wasm_add_uploaded_file"] = Module["asm"]["jb"]).apply(null, arguments);
};

Module["_wasm_set_query_string"] = function() {
 return (Module["_wasm_set_query_string"] = Module["asm"]["kb"]).apply(null, arguments);
};

Module["_wasm_set_path_translated"] = function() {
 return (Module["_wasm_set_path_translated"] = Module["asm"]["lb"]).apply(null, arguments);
};

Module["_wasm_set_skip_shebang"] = function() {
 return (Module["_wasm_set_skip_shebang"] = Module["asm"]["mb"]).apply(null, arguments);
};

Module["_wasm_set_request_uri"] = function() {
 return (Module["_wasm_set_request_uri"] = Module["asm"]["nb"]).apply(null, arguments);
};

Module["_wasm_set_request_method"] = function() {
 return (Module["_wasm_set_request_method"] = Module["asm"]["ob"]).apply(null, arguments);
};

Module["_wasm_set_request_host"] = function() {
 return (Module["_wasm_set_request_host"] = Module["asm"]["pb"]).apply(null, arguments);
};

Module["_wasm_set_content_type"] = function() {
 return (Module["_wasm_set_content_type"] = Module["asm"]["qb"]).apply(null, arguments);
};

Module["_wasm_set_request_body"] = function() {
 return (Module["_wasm_set_request_body"] = Module["asm"]["rb"]).apply(null, arguments);
};

Module["_wasm_set_content_length"] = function() {
 return (Module["_wasm_set_content_length"] = Module["asm"]["sb"]).apply(null, arguments);
};

Module["_wasm_set_cookies"] = function() {
 return (Module["_wasm_set_cookies"] = Module["asm"]["tb"]).apply(null, arguments);
};

Module["_wasm_set_php_code"] = function() {
 return (Module["_wasm_set_php_code"] = Module["asm"]["ub"]).apply(null, arguments);
};

Module["_wasm_set_request_port"] = function() {
 return (Module["_wasm_set_request_port"] = Module["asm"]["vb"]).apply(null, arguments);
};

Module["_phpwasm_init_uploaded_files_hash"] = function() {
 return (Module["_phpwasm_init_uploaded_files_hash"] = Module["asm"]["wb"]).apply(null, arguments);
};

Module["_phpwasm_register_uploaded_file"] = function() {
 return (Module["_phpwasm_register_uploaded_file"] = Module["asm"]["xb"]).apply(null, arguments);
};

Module["_phpwasm_destroy_uploaded_files_hash"] = function() {
 return (Module["_phpwasm_destroy_uploaded_files_hash"] = Module["asm"]["yb"]).apply(null, arguments);
};

Module["_wasm_sapi_handle_request"] = function() {
 return (Module["_wasm_sapi_handle_request"] = Module["asm"]["zb"]).apply(null, arguments);
};

Module["_php_wasm_init"] = function() {
 return (Module["_php_wasm_init"] = Module["asm"]["Ab"]).apply(null, arguments);
};
...
export { php7_1_node as default, dependenciesTotalSize, dependencyFilename };
