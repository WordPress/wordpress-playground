...
<div class="akismet-alert akismet-critical">
	...
	<p class="akismet-description">
		<?php
 echo wp_kses( sprintf( __( 'Please enter a new key or <a href="%s" target="_blank">contact Akismet support</a>.', 'akismet' ), 'https://akismet.com/contact/' ), array( 'a' => array( 'href' => true, 'target' => true, ), ) ); ?>
	</p>
</div>
...
<div class="akismet-alert akismet-critical">
	...
	<p class="akismet-description">
		<?php
 echo wp_kses( sprintf( __( 'The connection to akismet.com could not be established. Please refer to <a href="%s" target="_blank">our guide about firewalls</a> and check your server configuration.', 'akismet' ), 'https://blog.akismet.com/akismet-hosting-faq/' ), array( 'a' => array( 'href' => true, 'target' => true, ), ) ); ?>
	</p>
</div>
...
<div class="akismet-alert akismet-critical">
	...
	<p class="akismet-description">
		<?php
 echo wp_kses( sprintf( __( 'Your Plus subscription allows the use of Akismet on only one site. Please <a href="%s" target="_blank">purchase additional Plus subscriptions</a> or upgrade to an Enterprise subscription that allows the use of Akismet on unlimited sites.', 'akismet' ), 'https://docs.akismet.com/billing/add-more-sites/' ), array( 'a' => array( 'href' => true, 'target' => true, ), ) ); ?>
		<br /><br />
		<?php printf( __( 'Please <a href="%s" target="_blank">contact our support team</a> with any questions.', 'akismet' ), 'https://akismet.com/contact/'); ?>
	</p>
