...
<form method="post" action="site-info.php?action=update-site">
 ...
 if ( $is_main_site ) : ?>
		...
		<?php
 $attribute_fields = array( 'public' => _x( 'Public', 'site' ) ); if ( ! $is_main_site ) { $attribute_fields['archived'] = __( 'Archived' ); $attribute_fields['spam'] = _x( 'Spam', 'site' ); $attribute_fields['deleted'] = __( 'Deleted' ); } $attribute_fields['mature'] = __( 'Mature' ); ?>
		<tr>
	...
	<?php
 do_action( 'network_site_info_form', $id ); submit_button(); ?>
</form>
