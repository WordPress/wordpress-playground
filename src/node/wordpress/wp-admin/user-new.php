...
<?php if ( isset( $errors ) && is_wp_error( $errors ) ) : ?>
 ...
 foreach ( $errors->get_error_messages() as $err ) { echo "<li>$err</li>\n"; } ?>
	...
	<?php
endif; if ( ! empty( $messages ) ) { foreach ( $messages as $msg ) { echo '<div id="message" class="updated notice is-dismissible"><p>' . $msg . '</p></div>'; } } ?>
