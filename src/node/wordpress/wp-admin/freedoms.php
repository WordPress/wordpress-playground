<?php
 require_once __DIR__ . '/admin.php'; if ( isset( $_GET['privacy-notice'] ) ) { wp_redirect( admin_url( 'privacy.php' ), 301 ); exit; } $title = __( 'Freedoms' ); list( $display_version ) = explode( '-', get_bloginfo( 'version' ) ); require_once ABSPATH . 'wp-admin/admin-header.php'; ?>
<div class="wrap about__container">
	...
	<div class="about__section is-feature">
		...
		<?php
 printf( __( 'WordPress comes with some awesome, worldview-changing rights courtesy of its <a href="%s">license</a>, the GPL.' ), __( 'https://wordpress.org/about/license/' ) ); ?>
		</p>
	</div>
