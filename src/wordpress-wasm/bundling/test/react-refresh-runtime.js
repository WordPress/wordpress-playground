...
export function computeFullKey(signature) {
...
export function haveEqualSignatures(prevType, nextType) {
...
export function isReactClass(type) {
	return type.prototype && type.prototype.isReactComponent;
}

export function canPreserveStateBetween(prevType, nextType) {
...
window.performReactRefresh = performReactRefresh;
...
window.__register = window.register = register;
export function setSignature(type, key) {
	var forceReset =
...
export function injectIntoGlobalHook(globalObject) {
	{
		...
		console.log(hook, globalObject.__REACT_DEVTOOLS_GLOBAL_HOOK__);
...
window.createSignatureFunctionForTransform =
