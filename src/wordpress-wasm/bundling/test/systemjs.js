	...
	function r(e, n, r, i, o) {
		for (var s in e) {
			...
			if ('string' == typeof f) {
				...
				l
					? (n[a] = l)
					: u('W1', s, f, 'bare specifier did not resolve');
			}
		}
	}
	function i(e, t, i) {
		...
		var u = Promise.resolve()
				...
				.then(
					function (r) {
						if (!r)
							throw Error(
								e(2, 'Module ' + n + ' did not instantiate')
							);
						var u = r[1](
							function (e, t) {
								i.h = !0;
			...
			c = u.then(function (e) {
				return Promise.all(
					e[0].map(function (r, i) {
						var o = e[1][i];
						return Promise.resolve(t.resolve(r, n)).then(function (
							e
						) {
							var r = d(t, e, n);
							return Promise.resolve(r.I).then(function () {
								return (
									o && (r.i.push(o), (!r.h && r.I) || o(r.n)),
									r
								);
							});
						});
						...
						? (WebAssembly.compileStreaming
								...
								return (
									WebAssembly.Module.imports &&
										WebAssembly.Module.imports(n).forEach(
											function (e) {
