...
[API Reference](https://github.com/WordPress/wordpress-playground/tree/trunk/docs/api/php-wasm.md)
...
Below you'll find a few especially relevant parts of the API. Consult the [php-wasm API reference page](https://github.com/WordPress/wordpress-playground/tree/trunk/docs/api/php-wasm.md) to learn about the rest of it.
...
&emsp;&emsp;&emsp;<!-- -->runtime<!-- -->: [JavascriptRuntime](https:/github.com/WordPress/wordpress-playground/blob/trunk/docs/api/php-wasm.javascriptruntime.md)<!-- -->, \
...
)<!-- -->: [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)<!-- -->&lt;[PHP](https:/github.com/WordPress/wordpress-playground/blob/trunk/docs/api/php-wasm.php.md)<!-- -->&gt;
...
### PHPServer<!-- -->(<!-- -->php<!-- -->: [PHP](https:/github.com/WordPress/wordpress-playground/blob/trunk/docs/api/php-wasm.php.md)<!-- -->, config<!-- -->: [PHPServerConfigation](https:/github.com/WordPress/wordpress-playground/blob/trunk/docs/api/php-wasm.phpserverconfigation.md)<!-- -->)
