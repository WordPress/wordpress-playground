export declare type JavascriptRuntime = 'NODE' | 'WEB' | 'WEBWORKER';
/**
 * @internal
 */
interface Streams {
 ...
 */
export declare function startPHP(phpLoaderModule: any, runtime: JavascriptRuntime, phpModuleArgs?: any, dataDependenciesModules?: any[]): Promise<PHP>;
/**
